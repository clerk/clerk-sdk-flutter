  ...
  static UpdateInstanceRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return UpdateInstanceRequest(
        ...
        urlBasedSessionSyncing: mapValueOfType<bool>(json, r'url_based_session_syncing'),
      );
    }
    return null;
  }
