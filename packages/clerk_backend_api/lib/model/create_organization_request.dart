...
class CreateOrganizationRequest {
  ...
  @override
  String toString() => 'CreateOrganizationRequest[name=$name, createdBy=$createdBy, privateMetadata=$privateMetadata, publicMetadata=$publicMetadata, slug=$slug, maxAllowedMemberships=$maxAllowedMemberships, createdAt=$createdAt]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CreateOrganizationRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CreateOrganizationRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
