...
class PhoneNumberVerification {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PhoneNumberVerification &&
    other.status == status &&
  ...
  @override
  String toString() => 'PhoneNumberVerification[status=$status, strategy=$strategy, attempts=$attempts, expireAt=$expireAt, verifiedAtClient=$verifiedAtClient]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PhoneNumberVerification[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PhoneNumberVerification[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return PhoneNumberVerification(
        ...
        strategy: PhoneNumberVerificationStrategyEnum.fromJson(json[r'strategy'])!,
  ...
  static List<PhoneNumberVerification> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<PhoneNumberVerification>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PhoneNumberVerification>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PhoneNumberVerification.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class PhoneNumberVerificationStatusEnum {
  ...
  static PhoneNumberVerificationStatusEnum? fromJson(dynamic value) => PhoneNumberVerificationStatusEnumTypeTransformer().decode(value);

  static List<PhoneNumberVerificationStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class PhoneNumberVerificationStatusEnumTypeTransformer {
  factory PhoneNumberVerificationStatusEnumTypeTransformer() => _instance ??= const PhoneNumberVerificationStatusEnumTypeTransformer._();
  ...
  PhoneNumberVerificationStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'verified': return PhoneNumberVerificationStatusEnum.verified;
        default:
          if (!allowNull) {
...
class PhoneNumberVerificationStrategyEnum {
  ...
  static PhoneNumberVerificationStrategyEnum? fromJson(dynamic value) => PhoneNumberVerificationStrategyEnumTypeTransformer().decode(value);

  static List<PhoneNumberVerificationStrategyEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class PhoneNumberVerificationStrategyEnumTypeTransformer {
  factory PhoneNumberVerificationStrategyEnumTypeTransformer() => _instance ??= const PhoneNumberVerificationStrategyEnumTypeTransformer._();
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  PhoneNumberVerificationStrategyEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'admin': return PhoneNumberVerificationStrategyEnum.admin;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
