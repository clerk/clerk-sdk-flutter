...
class SAMLAccountSamlConnection {
  ...
  bool operator ==(Object other) =>
      ...
      other is SAMLAccountSamlConnection &&
          other.id == id &&
          other.name == name &&
          other.domain == domain &&
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "SAMLAccountSamlConnection[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "SAMLAccountSamlConnection[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SAMLAccountSamlConnection> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<SAMLAccountSamlConnection>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = SAMLAccountSamlConnection.listFromJson(
          entry.value,
          growable: growable,
        );
      }
