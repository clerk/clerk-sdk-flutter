...
class Instance {
  ...
  @override
  String toString() => 'Instance[object=$object, id=$id, environmentType=$environmentType, allowedOrigins=$allowedOrigins]';
    ...
    if (value is Map) {
      ...
      return Instance(
        ...
        allowedOrigins: json[r'allowed_origins'] is Iterable
            ? (json[r'allowed_origins'] as Iterable).cast<String>().toList(growable: false)
            : const [],
      );
    }
    return null;
...
class InstanceObjectEnum {
  ...
  static InstanceObjectEnum? fromJson(dynamic value) => InstanceObjectEnumTypeTransformer().decode(value);

  static List<InstanceObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class InstanceObjectEnumTypeTransformer {
  factory InstanceObjectEnumTypeTransformer() => _instance ??= const InstanceObjectEnumTypeTransformer._();
  ...
  InstanceObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'instance': return InstanceObjectEnum.instance;
        default:
          if (!allowNull) {
