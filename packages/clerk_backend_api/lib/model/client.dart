...
class Client {
  ...
  @override
  String toString() => 'Client[object=$object, id=$id, sessionIds=$sessionIds, sessions=$sessions, signInId=$signInId, signUpId=$signUpId, lastActiveSessionId=$lastActiveSessionId, updatedAt=$updatedAt, createdAt=$createdAt]';
    ...
    if (value is Map) {
      ...
      return Client(
        ...
        sessionIds: json[r'session_ids'] is Iterable
            ? (json[r'session_ids'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        ...
        lastActiveSessionId: mapValueOfType<String>(json, r'last_active_session_id'),
...
class ClientObjectEnum {
  ...
  static ClientObjectEnum? fromJson(dynamic value) => ClientObjectEnumTypeTransformer().decode(value);

  static List<ClientObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class ClientObjectEnumTypeTransformer {
  factory ClientObjectEnumTypeTransformer() => _instance ??= const ClientObjectEnumTypeTransformer._();
  ...
  ClientObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'client': return ClientObjectEnum.client;
        default:
          if (!allowNull) {
