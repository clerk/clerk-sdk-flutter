  ...
  group('SignUp', () {
    ...
    test('can sign up with emailCode with typo in first email', () async {
      await runWithLogging(() async {
        ...
        final typoEmailAddress = '$username-TYPO+clerk_test@some.domain';

        httpService.expect(
          'POST /v1/client/sign_ups strategy=email_code&email_address=$typoEmailAddress',
          200,
        ...
        client = await auth.attemptSignUp(
          strategy: Strategy.emailCode,
          emailAddress: emailAddress, // correct the address
          code: env.code,
        );
        expect(client.signUp, null);
        expect(client.user is User, true);
