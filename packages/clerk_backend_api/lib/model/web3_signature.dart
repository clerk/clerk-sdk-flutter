...
class Web3Signature {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Web3Signature &&
    other.status == status &&
  ...
  @override
  String toString() => 'Web3Signature[status=$status, strategy=$strategy, nonce=$nonce, message=$message, attempts=$attempts, expireAt=$expireAt, verifiedAtClient=$verifiedAtClient]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "Web3Signature[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "Web3Signature[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<Web3Signature> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<Web3Signature>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<Web3Signature>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = Web3Signature.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class Web3SignatureStatusEnum {
  ...
  static Web3SignatureStatusEnum? fromJson(dynamic value) => Web3SignatureStatusEnumTypeTransformer().decode(value);

  static List<Web3SignatureStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class Web3SignatureStatusEnumTypeTransformer {
  factory Web3SignatureStatusEnumTypeTransformer() => _instance ??= const Web3SignatureStatusEnumTypeTransformer._();
  ...
  Web3SignatureStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'unverified': return Web3SignatureStatusEnum.unverified;
        case r'verified': return Web3SignatureStatusEnum.verified;
        case r'failed': return Web3SignatureStatusEnum.failed;
        case r'expired': return Web3SignatureStatusEnum.expired;
        default:
          if (!allowNull) {
...
class Web3SignatureStrategyEnum {
  ...
  static const metamaskSignature = Web3SignatureStrategyEnum._(r'web3_metamask_signature');
  static const coinbaseWalletSignature = Web3SignatureStrategyEnum._(r'web3_coinbase_wallet_signature');
  static const okxWalletSignature = Web3SignatureStrategyEnum._(r'web3_okx_wallet_signature');
  ...
  static Web3SignatureStrategyEnum? fromJson(dynamic value) => Web3SignatureStrategyEnumTypeTransformer().decode(value);

  static List<Web3SignatureStrategyEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class Web3SignatureStrategyEnumTypeTransformer {
  factory Web3SignatureStrategyEnumTypeTransformer() => _instance ??= const Web3SignatureStrategyEnumTypeTransformer._();
  ...
  Web3SignatureStrategyEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'web3_metamask_signature': return Web3SignatureStrategyEnum.metamaskSignature;
        case r'web3_coinbase_wallet_signature': return Web3SignatureStrategyEnum.coinbaseWalletSignature;
        case r'web3_okx_wallet_signature': return Web3SignatureStrategyEnum.okxWalletSignature;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
