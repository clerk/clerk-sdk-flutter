...
class UpdateInstanceAuthConfigRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UpdateInstanceAuthConfigRequest &&
  ...
  @override
  String toString() => 'UpdateInstanceAuthConfigRequest[restrictedToAllowlist=$restrictedToAllowlist, fromEmailAddress=$fromEmailAddress, progressiveSignUp=$progressiveSignUp, enhancedEmailDeliverability=$enhancedEmailDeliverability, testMode=$testMode]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UpdateInstanceAuthConfigRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UpdateInstanceAuthConfigRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return UpdateInstanceAuthConfigRequest(
        restrictedToAllowlist: mapValueOfType<bool>(json, r'restricted_to_allowlist') ?? false,
  ...
  static List<UpdateInstanceAuthConfigRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, UpdateInstanceAuthConfigRequest> mapFromJson(dynamic json) {
  ...
  static Map<String, List<UpdateInstanceAuthConfigRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UpdateInstanceAuthConfigRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UpdateInstanceAuthConfigRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
