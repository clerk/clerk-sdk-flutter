...
class OTP {
  ...
  @override
  String toString() => 'OTP[status=$status, strategy=$strategy, attempts=$attempts, expireAt=$expireAt, verifiedAtClient=$verifiedAtClient]';
...
class OTPStatusEnum {
  ...
  static OTPStatusEnum? fromJson(dynamic value) => OTPStatusEnumTypeTransformer().decode(value);

  static List<OTPStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class OTPStatusEnumTypeTransformer {
  factory OTPStatusEnumTypeTransformer() => _instance ??= const OTPStatusEnumTypeTransformer._();
  ...
  OTPStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'unverified': return OTPStatusEnum.unverified;
        case r'verified': return OTPStatusEnum.verified;
        case r'failed': return OTPStatusEnum.failed;
        case r'expired': return OTPStatusEnum.expired;
        default:
          if (!allowNull) {
...
class OTPStrategyEnum {
  ...
  static const resetPasswordEmailCode = OTPStrategyEnum._(r'reset_password_email_code');
  ...
  static OTPStrategyEnum? fromJson(dynamic value) => OTPStrategyEnumTypeTransformer().decode(value);

  static List<OTPStrategyEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class OTPStrategyEnumTypeTransformer {
  factory OTPStrategyEnumTypeTransformer() => _instance ??= const OTPStrategyEnumTypeTransformer._();
  ...
  OTPStrategyEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'phone_code': return OTPStrategyEnum.phoneCode;
        case r'email_code': return OTPStrategyEnum.emailCode;
        case r'reset_password_email_code': return OTPStrategyEnum.resetPasswordEmailCode;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
