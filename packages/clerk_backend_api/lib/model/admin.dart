...
class Admin {
  ...
  @override
  String toString() => 'Admin[status=$status, strategy=$strategy, attempts=$attempts, expireAt=$expireAt, verifiedAtClient=$verifiedAtClient]';
...
class AdminStatusEnum {
  ...
  static AdminStatusEnum? fromJson(dynamic value) => AdminStatusEnumTypeTransformer().decode(value);

  static List<AdminStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class AdminStatusEnumTypeTransformer {
  factory AdminStatusEnumTypeTransformer() => _instance ??= const AdminStatusEnumTypeTransformer._();
  ...
  AdminStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'verified': return AdminStatusEnum.verified;
        default:
          if (!allowNull) {
...
class AdminStrategyEnum {
  ...
  static AdminStrategyEnum? fromJson(dynamic value) => AdminStrategyEnumTypeTransformer().decode(value);

  static List<AdminStrategyEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class AdminStrategyEnumTypeTransformer {
  factory AdminStrategyEnumTypeTransformer() => _instance ??= const AdminStrategyEnumTypeTransformer._();
  ...
  AdminStrategyEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'admin': return AdminStrategyEnum.admin;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
