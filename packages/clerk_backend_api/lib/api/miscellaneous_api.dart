...
class MiscellaneousApi {
  ...
  Future<http.Response> getPublicInterstitialWithHttpInfo({ String? frontendApi, String? frontendApi2, String? publishableKey, String? proxyUrl, String? domain, String? signInUrl, bool? useDomainForScript, }) async {
    ...
    if (useDomainForScript != null) {
      queryParams.addAll(_queryParams('', 'use_domain_for_script', useDomainForScript));
    }
  ...
  /// * [bool] useDomainForScript:
  ///   Whether to use the domain for the script URL
  Future<void> getPublicInterstitial({ String? frontendApi, String? frontendApi2, String? publishableKey, String? proxyUrl, String? domain, String? signInUrl, bool? useDomainForScript, }) async {
    final response = await getPublicInterstitialWithHttpInfo( frontendApi: frontendApi, frontendApi2: frontendApi2, publishableKey: publishableKey, proxyUrl: proxyUrl, domain: domain, signInUrl: signInUrl, useDomainForScript: useDomainForScript, );
