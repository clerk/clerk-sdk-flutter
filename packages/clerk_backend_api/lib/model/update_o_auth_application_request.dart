...
class UpdateOAuthApplicationRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UpdateOAuthApplicationRequest &&
    other.name == name &&
  ...
  @override
  String toString() => 'UpdateOAuthApplicationRequest[name=$name, redirectUris=$redirectUris, callbackUrl=$callbackUrl, scopes=$scopes, public=$public]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UpdateOAuthApplicationRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UpdateOAuthApplicationRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UpdateOAuthApplicationRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<UpdateOAuthApplicationRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UpdateOAuthApplicationRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UpdateOAuthApplicationRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
