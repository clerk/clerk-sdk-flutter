...
class BlocklistIdentifiers {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is BlocklistIdentifiers &&
  ...
  @override
  String toString() => 'BlocklistIdentifiers[data=$data, totalCount=$totalCount]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "BlocklistIdentifiers[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "BlocklistIdentifiers[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<BlocklistIdentifiers> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<BlocklistIdentifiers>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<BlocklistIdentifiers>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = BlocklistIdentifiers.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
