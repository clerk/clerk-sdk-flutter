...
class OrganizationMembership {
  ...
  @override
  String toString() => 'OrganizationMembership[id=$id, object=$object, role=$role, roleName=$roleName, permissions=$permissions, publicMetadata=$publicMetadata, privateMetadata=$privateMetadata, organization=$organization, publicUserData=$publicUserData, createdAt=$createdAt, updatedAt=$updatedAt]';
  ...
  static OrganizationMembership? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return OrganizationMembership(
        ...
        publicUserData: OrganizationMembershipPublicUserData.fromJson(json[r'public_user_data']),
...
class OrganizationMembershipObjectEnum {
  ...
  static const organizationMembership = OrganizationMembershipObjectEnum._(r'organization_membership');
  ...
  static OrganizationMembershipObjectEnum? fromJson(dynamic value) => OrganizationMembershipObjectEnumTypeTransformer().decode(value);

  static List<OrganizationMembershipObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class OrganizationMembershipObjectEnumTypeTransformer {
  factory OrganizationMembershipObjectEnumTypeTransformer() => _instance ??= const OrganizationMembershipObjectEnumTypeTransformer._();
  ...
  OrganizationMembershipObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'organization_membership': return OrganizationMembershipObjectEnum.organizationMembership;
        default:
          if (!allowNull) {
