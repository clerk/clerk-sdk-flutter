...
class OAuthApplicationWithSecret {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is OAuthApplicationWithSecret &&
    other.object == object &&
    other.id == id &&
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "OAuthApplicationWithSecret[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "OAuthApplicationWithSecret[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return OAuthApplicationWithSecret(
        ...
        tokenIntrospectionUrl: mapValueOfType<String>(json, r'token_introspection_url')!,
  ...
  static List<OAuthApplicationWithSecret> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<OAuthApplicationWithSecret>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<OAuthApplicationWithSecret>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = OAuthApplicationWithSecret.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class OAuthApplicationWithSecretObjectEnum {
  ...
  static const oauthApplication = OAuthApplicationWithSecretObjectEnum._(r'oauth_application');
  ...
  static OAuthApplicationWithSecretObjectEnum? fromJson(dynamic value) => OAuthApplicationWithSecretObjectEnumTypeTransformer().decode(value);

  static List<OAuthApplicationWithSecretObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class OAuthApplicationWithSecretObjectEnumTypeTransformer {
  factory OAuthApplicationWithSecretObjectEnumTypeTransformer() => _instance ??= const OAuthApplicationWithSecretObjectEnumTypeTransformer._();
  ...
  OAuthApplicationWithSecretObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'oauth_application': return OAuthApplicationWithSecretObjectEnum.oauthApplication;
        default:
          if (!allowNull) {
