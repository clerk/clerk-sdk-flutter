...
class SchemasPasskeyVerification {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SchemasPasskeyVerification &&
    other.status == status &&
  ...
  @override
  String toString() => 'SchemasPasskeyVerification[status=$status, strategy=$strategy, nonce=$nonce, message=$message, attempts=$attempts, expireAt=$expireAt, verifiedAtClient=$verifiedAtClient]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SchemasPasskeyVerification[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SchemasPasskeyVerification[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return SchemasPasskeyVerification(
        ...
        strategy: SchemasPasskeyVerificationStrategyEnum.fromJson(json[r'strategy'])!,
  ...
  static List<SchemasPasskeyVerification> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<SchemasPasskeyVerification>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SchemasPasskeyVerification>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SchemasPasskeyVerification.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class SchemasPasskeyVerificationStatusEnum {
  ...
  static SchemasPasskeyVerificationStatusEnum? fromJson(dynamic value) => SchemasPasskeyVerificationStatusEnumTypeTransformer().decode(value);

  static List<SchemasPasskeyVerificationStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class SchemasPasskeyVerificationStatusEnumTypeTransformer {
  factory SchemasPasskeyVerificationStatusEnumTypeTransformer() => _instance ??= const SchemasPasskeyVerificationStatusEnumTypeTransformer._();
  ...
  SchemasPasskeyVerificationStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'verified': return SchemasPasskeyVerificationStatusEnum.verified;
        default:
          if (!allowNull) {
...
class SchemasPasskeyVerificationStrategyEnum {
  ...
  static SchemasPasskeyVerificationStrategyEnum? fromJson(dynamic value) => SchemasPasskeyVerificationStrategyEnumTypeTransformer().decode(value);

  static List<SchemasPasskeyVerificationStrategyEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class SchemasPasskeyVerificationStrategyEnumTypeTransformer {
  factory SchemasPasskeyVerificationStrategyEnumTypeTransformer() => _instance ??= const SchemasPasskeyVerificationStrategyEnumTypeTransformer._();
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  SchemasPasskeyVerificationStrategyEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'passkey': return SchemasPasskeyVerificationStrategyEnum.passkey;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
...
class SchemasPasskeyVerificationNonceEnum {
  ...
  static SchemasPasskeyVerificationNonceEnum? fromJson(dynamic value) => SchemasPasskeyVerificationNonceEnumTypeTransformer().decode(value);

  static List<SchemasPasskeyVerificationNonceEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class SchemasPasskeyVerificationNonceEnumTypeTransformer {
  factory SchemasPasskeyVerificationNonceEnumTypeTransformer() => _instance ??= const SchemasPasskeyVerificationNonceEnumTypeTransformer._();
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  SchemasPasskeyVerificationNonceEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'nonce': return SchemasPasskeyVerificationNonceEnum.nonce;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
