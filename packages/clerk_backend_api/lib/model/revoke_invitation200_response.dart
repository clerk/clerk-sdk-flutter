...
class RevokeInvitation200Response {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is RevokeInvitation200Response &&
    other.object == object &&
    other.id == id &&
  ...
  @override
  String toString() => 'RevokeInvitation200Response[object=$object, id=$id, emailAddress=$emailAddress, publicMetadata=$publicMetadata, revoked=$revoked, status=$status, url=$url, expiresAt=$expiresAt, createdAt=$createdAt, updatedAt=$updatedAt]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RevokeInvitation200Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RevokeInvitation200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return RevokeInvitation200Response(
        object: RevokeInvitation200ResponseObjectEnum.fromJson(json[r'object'])!,
        ...
        status: RevokeInvitation200ResponseStatusEnum.fromJson(json[r'status'])!,
  ...
  static List<RevokeInvitation200Response> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<RevokeInvitation200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RevokeInvitation200Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = RevokeInvitation200Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class RevokeInvitation200ResponseObjectEnum {
  ...
  static const invitation = RevokeInvitation200ResponseObjectEnum._(r'invitation');
  ...
  static RevokeInvitation200ResponseObjectEnum? fromJson(dynamic value) => RevokeInvitation200ResponseObjectEnumTypeTransformer().decode(value);

  static List<RevokeInvitation200ResponseObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class RevokeInvitation200ResponseObjectEnumTypeTransformer {
  factory RevokeInvitation200ResponseObjectEnumTypeTransformer() => _instance ??= const RevokeInvitation200ResponseObjectEnumTypeTransformer._();
  ...
  RevokeInvitation200ResponseObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'invitation': return RevokeInvitation200ResponseObjectEnum.invitation;
        default:
          if (!allowNull) {
...
class RevokeInvitation200ResponseStatusEnum {
  ...
  static RevokeInvitation200ResponseStatusEnum? fromJson(dynamic value) => RevokeInvitation200ResponseStatusEnumTypeTransformer().decode(value);

  static List<RevokeInvitation200ResponseStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class RevokeInvitation200ResponseStatusEnumTypeTransformer {
  factory RevokeInvitation200ResponseStatusEnumTypeTransformer() => _instance ??= const RevokeInvitation200ResponseStatusEnumTypeTransformer._();
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  RevokeInvitation200ResponseStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'revoked': return RevokeInvitation200ResponseStatusEnum.revoked;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
