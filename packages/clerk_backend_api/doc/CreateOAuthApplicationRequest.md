# openapi.model.CreateOAuthApplicationRequest
...
**consentScreenEnabled** | **bool** | True to enable a consent screen to display in the authentication flow. | [optional] [default to true]
**pkceRequired** | **bool** | True to require the Proof Key of Code Exchange (PKCE) flow. | [optional] [default to false]
