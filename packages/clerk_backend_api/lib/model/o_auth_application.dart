...
class OAuthApplication {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is OAuthApplication &&
    other.object == object &&
    other.id == id &&
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "OAuthApplication[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "OAuthApplication[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<OAuthApplication> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<OAuthApplication>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<OAuthApplication>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = OAuthApplication.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class OAuthApplicationObjectEnum {
  ...
  static const oauthApplication = OAuthApplicationObjectEnum._(r'oauth_application');
  ...
  static OAuthApplicationObjectEnum? fromJson(dynamic value) => OAuthApplicationObjectEnumTypeTransformer().decode(value);

  static List<OAuthApplicationObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class OAuthApplicationObjectEnumTypeTransformer {
  factory OAuthApplicationObjectEnumTypeTransformer() => _instance ??= const OAuthApplicationObjectEnumTypeTransformer._();
  ...
  OAuthApplicationObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'oauth_application': return OAuthApplicationObjectEnum.oauthApplication;
        default:
          if (!allowNull) {
