...
class OAuthApplicationsApi {
  OAuthApplicationsApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<http.Response> createOAuthApplicationWithHttpInfo({ CreateOAuthApplicationRequest? createOAuthApplicationRequest, }) async {
  ...
  Future<OAuthApplicationWithSecret?> createOAuthApplication({ CreateOAuthApplicationRequest? createOAuthApplicationRequest, }) async {
    final response = await createOAuthApplicationWithHttpInfo( createOAuthApplicationRequest: createOAuthApplicationRequest, );
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'OAuthApplicationWithSecret',) as OAuthApplicationWithSecret;
  ...
  Future<http.Response> deleteOAuthApplicationWithHttpInfo(String oauthApplicationId,) async {
    // ignore: prefer_const_declarations
  ...
  Future<DeletedObject?> deleteOAuthApplication(String oauthApplicationId,) async {
    final response = await deleteOAuthApplicationWithHttpInfo(oauthApplicationId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<http.Response> getOAuthApplicationWithHttpInfo(String oauthApplicationId,) async {
    // ignore: prefer_const_declarations
    final path = r'/oauth_applications/{oauth_application_id}'
      .replaceAll('{oauth_application_id}', oauthApplicationId);
  ...
  Future<OAuthApplication?> getOAuthApplication(String oauthApplicationId,) async {
    final response = await getOAuthApplicationWithHttpInfo(oauthApplicationId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'OAuthApplication',) as OAuthApplication;
  ...
  Future<http.Response> listOAuthApplicationsWithHttpInfo({ int? limit, int? offset, }) async {
    // ignore: prefer_const_declarations
    final path = r'/oauth_applications';
  ...
  Future<OAuthApplications?> listOAuthApplications({ int? limit, int? offset, }) async {
    final response = await listOAuthApplicationsWithHttpInfo( limit: limit, offset: offset, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'OAuthApplications',) as OAuthApplications;
  ...
  Future<http.Response> rotateOAuthApplicationSecretWithHttpInfo(String oauthApplicationId,) async {
    // ignore: prefer_const_declarations
  ...
  Future<OAuthApplicationWithSecret?> rotateOAuthApplicationSecret(String oauthApplicationId,) async {
    final response = await rotateOAuthApplicationSecretWithHttpInfo(oauthApplicationId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<http.Response> updateOAuthApplicationWithHttpInfo(String oauthApplicationId, UpdateOAuthApplicationRequest updateOAuthApplicationRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/oauth_applications/{oauth_application_id}'
      .replaceAll('{oauth_application_id}', oauthApplicationId);
  ...
  Future<OAuthApplication?> updateOAuthApplication(String oauthApplicationId, UpdateOAuthApplicationRequest updateOAuthApplicationRequest,) async {
    final response = await updateOAuthApplicationWithHttpInfo(oauthApplicationId, updateOAuthApplicationRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
