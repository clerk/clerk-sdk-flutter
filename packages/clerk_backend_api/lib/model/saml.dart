...
class SAML {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SAML &&
    other.status == status &&
  ...
  @override
  String toString() => 'SAML[status=$status, strategy=$strategy, externalVerificationRedirectUrl=$externalVerificationRedirectUrl, error=$error, expireAt=$expireAt, attempts=$attempts, verifiedAtClient=$verifiedAtClient]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SAML[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SAML[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SAML> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SAML>[];
  ...
  static Map<String, List<SAML>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SAML>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SAML.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class SAMLStatusEnum {
  ...
  static SAMLStatusEnum? fromJson(dynamic value) => SAMLStatusEnumTypeTransformer().decode(value);

  static List<SAMLStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class SAMLStatusEnumTypeTransformer {
  factory SAMLStatusEnumTypeTransformer() => _instance ??= const SAMLStatusEnumTypeTransformer._();
  ...
  SAMLStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'unverified': return SAMLStatusEnum.unverified;
        case r'verified': return SAMLStatusEnum.verified;
        case r'failed': return SAMLStatusEnum.failed;
        case r'expired': return SAMLStatusEnum.expired;
        case r'transferable': return SAMLStatusEnum.transferable;
        default:
          if (!allowNull) {
...
class SAMLStrategyEnum {
  ...
  static SAMLStrategyEnum? fromJson(dynamic value) => SAMLStrategyEnumTypeTransformer().decode(value);

  static List<SAMLStrategyEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class SAMLStrategyEnumTypeTransformer {
  factory SAMLStrategyEnumTypeTransformer() => _instance ??= const SAMLStrategyEnumTypeTransformer._();
  ...
  SAMLStrategyEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'saml': return SAMLStrategyEnum.saml;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
