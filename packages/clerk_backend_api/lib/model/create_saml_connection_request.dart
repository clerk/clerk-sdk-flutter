...
class CreateSAMLConnectionRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreateSAMLConnectionRequest &&
    other.name == name &&
    other.domain == domain &&
  ...
  @override
  String toString() => 'CreateSAMLConnectionRequest[name=$name, domain=$domain, provider=$provider, idpEntityId=$idpEntityId, idpSsoUrl=$idpSsoUrl, idpCertificate=$idpCertificate, idpMetadataUrl=$idpMetadataUrl, idpMetadata=$idpMetadata, organizationId=$organizationId, attributeMapping=$attributeMapping]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CreateSAMLConnectionRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CreateSAMLConnectionRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return CreateSAMLConnectionRequest(
        ...
        provider: CreateSAMLConnectionRequestProviderEnum.fromJson(json[r'provider'])!,
        ...
        attributeMapping: CreateSAMLConnectionRequestAttributeMapping.fromJson(json[r'attribute_mapping']),
      );
    }
    return null;
  }

  static List<CreateSAMLConnectionRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<CreateSAMLConnectionRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CreateSAMLConnectionRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CreateSAMLConnectionRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class CreateSAMLConnectionRequestProviderEnum {
  ...
  static const custom = CreateSAMLConnectionRequestProviderEnum._(r'saml_custom');
  static const okta = CreateSAMLConnectionRequestProviderEnum._(r'saml_okta');
  static const google = CreateSAMLConnectionRequestProviderEnum._(r'saml_google');
  static const microsoft = CreateSAMLConnectionRequestProviderEnum._(r'saml_microsoft');
  ...
  static CreateSAMLConnectionRequestProviderEnum? fromJson(dynamic value) => CreateSAMLConnectionRequestProviderEnumTypeTransformer().decode(value);

  static List<CreateSAMLConnectionRequestProviderEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class CreateSAMLConnectionRequestProviderEnumTypeTransformer {
  factory CreateSAMLConnectionRequestProviderEnumTypeTransformer() => _instance ??= const CreateSAMLConnectionRequestProviderEnumTypeTransformer._();
  ...
  CreateSAMLConnectionRequestProviderEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'saml_custom': return CreateSAMLConnectionRequestProviderEnum.custom;
        case r'saml_okta': return CreateSAMLConnectionRequestProviderEnum.okta;
        case r'saml_google': return CreateSAMLConnectionRequestProviderEnum.google;
        case r'saml_microsoft': return CreateSAMLConnectionRequestProviderEnum.microsoft;
        default:
          if (!allowNull) {
