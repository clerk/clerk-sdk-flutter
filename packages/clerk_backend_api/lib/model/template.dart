    ...
    if (value is Map) {
      ...
      return Template(
        ...
        availableVariables: json[r'available_variables'] is Iterable
            ? (json[r'available_variables'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        requiredVariables: json[r'required_variables'] is Iterable
            ? (json[r'required_variables'] as Iterable).cast<String>().toList(growable: false)
            : const [],
...
class TemplateObjectEnum {
  ...
  static TemplateObjectEnum? fromJson(dynamic value) => TemplateObjectEnumTypeTransformer().decode(value);

  static List<TemplateObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class TemplateObjectEnumTypeTransformer {
  factory TemplateObjectEnumTypeTransformer() => _instance ??= const TemplateObjectEnumTypeTransformer._();
  ...
  TemplateObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'template': return TemplateObjectEnum.template;
        default:
          if (!allowNull) {
