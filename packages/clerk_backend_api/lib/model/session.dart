...
class Session {
  ...
  int get hashCode =>
    ...
    (status.hashCode) +
    (lastActiveOrganizationId == null ? 0 : lastActiveOrganizationId!.hashCode) +
  ...
  @override
  String toString() => 'Session[object=$object, id=$id, userId=$userId, clientId=$clientId, actor=$actor, status=$status, lastActiveOrganizationId=$lastActiveOrganizationId, lastActiveAt=$lastActiveAt, latestActivity=$latestActivity, expireAt=$expireAt, abandonAt=$abandonAt, updatedAt=$updatedAt, createdAt=$createdAt]';
  ...
  static Session? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Session(
        ...
        lastActiveOrganizationId: mapValueOfType<String>(json, r'last_active_organization_id'),
        lastActiveAt: mapValueOfType<int>(json, r'last_active_at')!,
        latestActivity: SessionActivityResponse.fromJson(json[r'latest_activity']),
...
class SessionObjectEnum {
  ...
  static SessionObjectEnum? fromJson(dynamic value) => SessionObjectEnumTypeTransformer().decode(value);

  static List<SessionObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class SessionObjectEnumTypeTransformer {
  factory SessionObjectEnumTypeTransformer() => _instance ??= const SessionObjectEnumTypeTransformer._();
  ...
  SessionObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'session': return SessionObjectEnum.session;
        default:
          if (!allowNull) {
...
class SessionStatusEnum {
  ...
  static SessionStatusEnum? fromJson(dynamic value) => SessionStatusEnumTypeTransformer().decode(value);

  static List<SessionStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class SessionStatusEnumTypeTransformer {
  factory SessionStatusEnumTypeTransformer() => _instance ??= const SessionStatusEnumTypeTransformer._();
  ...
  SessionStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'active': return SessionStatusEnum.active;
        case r'revoked': return SessionStatusEnum.revoked;
        case r'ended': return SessionStatusEnum.ended;
        case r'expired': return SessionStatusEnum.expired;
        case r'removed': return SessionStatusEnum.removed;
        case r'abandoned': return SessionStatusEnum.abandoned;
        case r'replaced': return SessionStatusEnum.replaced;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
