...
class OrganizationSettings {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is OrganizationSettings &&
    other.object == object &&
    ...
    _deepEquality.equals(other.domainsEnrollmentModes, domainsEnrollmentModes) &&
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "OrganizationSettings[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "OrganizationSettings[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return OrganizationSettings(
        ...
        maxAllowedMemberships: mapValueOfType<int>(json, r'max_allowed_memberships')!,
        maxAllowedRoles: mapValueOfType<int>(json, r'max_allowed_roles')!,
        maxAllowedPermissions: mapValueOfType<int>(json, r'max_allowed_permissions')!,
        ...
        domainsEnrollmentModes: OrganizationSettingsDomainsEnrollmentModesEnum.listFromJson(json[r'domains_enrollment_modes']),
        domainsDefaultRole: mapValueOfType<String>(json, r'domains_default_role')!,
      );
    }
    return null;
  }

  static List<OrganizationSettings> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<OrganizationSettings>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<OrganizationSettings>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = OrganizationSettings.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class OrganizationSettingsObjectEnum {
  ...
  static const organizationSettings = OrganizationSettingsObjectEnum._(r'organization_settings');
  ...
  static OrganizationSettingsObjectEnum? fromJson(dynamic value) => OrganizationSettingsObjectEnumTypeTransformer().decode(value);

  static List<OrganizationSettingsObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class OrganizationSettingsObjectEnumTypeTransformer {
  factory OrganizationSettingsObjectEnumTypeTransformer() => _instance ??= const OrganizationSettingsObjectEnumTypeTransformer._();
  ...
  OrganizationSettingsObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'organization_settings': return OrganizationSettingsObjectEnum.organizationSettings;
        default:
          if (!allowNull) {
...
class OrganizationSettingsDomainsEnrollmentModesEnum {
  ...
  static const manualInvitation = OrganizationSettingsDomainsEnrollmentModesEnum._(r'manual_invitation');
  static const automaticInvitation = OrganizationSettingsDomainsEnrollmentModesEnum._(r'automatic_invitation');
  static const automaticSuggestion = OrganizationSettingsDomainsEnrollmentModesEnum._(r'automatic_suggestion');
  ...
  static OrganizationSettingsDomainsEnrollmentModesEnum? fromJson(dynamic value) => OrganizationSettingsDomainsEnrollmentModesEnumTypeTransformer().decode(value);

  static List<OrganizationSettingsDomainsEnrollmentModesEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <OrganizationSettingsDomainsEnrollmentModesEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = OrganizationSettingsDomainsEnrollmentModesEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
class OrganizationSettingsDomainsEnrollmentModesEnumTypeTransformer {
  factory OrganizationSettingsDomainsEnrollmentModesEnumTypeTransformer() => _instance ??= const OrganizationSettingsDomainsEnrollmentModesEnumTypeTransformer._();

  const OrganizationSettingsDomainsEnrollmentModesEnumTypeTransformer._();

  String encode(OrganizationSettingsDomainsEnrollmentModesEnum data) => data.value;
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  OrganizationSettingsDomainsEnrollmentModesEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'manual_invitation': return OrganizationSettingsDomainsEnrollmentModesEnum.manualInvitation;
        case r'automatic_invitation': return OrganizationSettingsDomainsEnrollmentModesEnum.automaticInvitation;
        case r'automatic_suggestion': return OrganizationSettingsDomainsEnrollmentModesEnum.automaticSuggestion;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  static OrganizationSettingsDomainsEnrollmentModesEnumTypeTransformer? _instance;
}
