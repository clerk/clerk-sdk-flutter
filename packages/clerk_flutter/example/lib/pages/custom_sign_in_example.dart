...
/// sign in flow.
@immutable
class CustomSignInExample extends StatefulWidget {
  /// Constructs an instance of [CustomSignInExample].
  const CustomSignInExample({super.key});

  /// Path to this page.
  static const path = '/custom-sign-in-example';

  @override
  State<CustomSignInExample> createState() => _CustomSignInExampleState();
}

class _CustomSignInExampleState extends State<CustomSignInExample> {
