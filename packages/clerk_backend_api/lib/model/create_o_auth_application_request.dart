...
class CreateOAuthApplicationRequest {
  ...
  bool operator ==(Object other) =>
      ...
      other is CreateOAuthApplicationRequest &&
          other.name == name &&
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "CreateOAuthApplicationRequest[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "CreateOAuthApplicationRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CreateOAuthApplicationRequest> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<CreateOAuthApplicationRequest>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = CreateOAuthApplicationRequest.listFromJson(
          entry.value,
          growable: growable,
        );
      }
