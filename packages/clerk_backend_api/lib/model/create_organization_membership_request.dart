...
class CreateOrganizationMembershipRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreateOrganizationMembershipRequest &&
    other.userId == userId &&
    other.role == role;
  ...
  @override
  String toString() => 'CreateOrganizationMembershipRequest[userId=$userId, role=$role]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CreateOrganizationMembershipRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CreateOrganizationMembershipRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CreateOrganizationMembershipRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, CreateOrganizationMembershipRequest> mapFromJson(dynamic json) {
  ...
  static Map<String, List<CreateOrganizationMembershipRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CreateOrganizationMembershipRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CreateOrganizationMembershipRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
