...
class Strategy {
  ...
  static const oauthTokenGoogle = Strategy(name: _oauthToken, provider: 'google');
  ...
  static const web3OkxWalletSignature = Strategy(name: 'web3_okx_wallet_signature');
  ...
  bool get requiresSignature =>
      const [web3MetamaskSignature, web3CoinbaseSignature, web3OkxWalletSignature].contains(this);
