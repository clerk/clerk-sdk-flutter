...
class OrganizationInvitationWithPublicOrganizationData {
  ...
  @override
  String toString() =>
      'OrganizationInvitationWithPublicOrganizationData[object=$object, id=$id, emailAddress=$emailAddress, role=$role, roleName=$roleName, organizationId=$organizationId, inviterId=$inviterId, publicInviterData=$publicInviterData, status=$status, publicMetadata=$publicMetadata, privateMetadata=$privateMetadata, url=$url, expiresAt=$expiresAt, createdAt=$createdAt, updatedAt=$updatedAt, publicOrganizationData=$publicOrganizationData]';
