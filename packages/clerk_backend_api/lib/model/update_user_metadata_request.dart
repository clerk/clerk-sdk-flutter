...
class UpdateUserMetadataRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UpdateUserMetadataRequest &&
  ...
  @override
  String toString() => 'UpdateUserMetadataRequest[publicMetadata=$publicMetadata, privateMetadata=$privateMetadata, unsafeMetadata=$unsafeMetadata]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UpdateUserMetadataRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UpdateUserMetadataRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UpdateUserMetadataRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<UpdateUserMetadataRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UpdateUserMetadataRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UpdateUserMetadataRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
