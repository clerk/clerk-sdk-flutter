...
class SAMLAccountVerification {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SAMLAccountVerification &&
    other.status == status &&
    other.strategy == strategy &&
    other.externalVerificationRedirectUrl == externalVerificationRedirectUrl &&
    other.error == error &&
  ...
  int get hashCode =>
    ...
    (status.hashCode) +
    (strategy.hashCode) +
    (externalVerificationRedirectUrl == null ? 0 : externalVerificationRedirectUrl!.hashCode) +
  ...
  @override
  String toString() => 'SAMLAccountVerification[status=$status, strategy=$strategy, externalVerificationRedirectUrl=$externalVerificationRedirectUrl, error=$error, expireAt=$expireAt, attempts=$attempts, verifiedAtClient=$verifiedAtClient]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.externalVerificationRedirectUrl != null) {
      json[r'external_verification_redirect_url'] = this.externalVerificationRedirectUrl;
    } else {
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SAMLAccountVerification[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SAMLAccountVerification[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return SAMLAccountVerification(
        ...
        strategy: SAMLAccountVerificationStrategyEnum.fromJson(json[r'strategy'])!,
        externalVerificationRedirectUrl: mapValueOfType<String>(json, r'external_verification_redirect_url'),
  ...
  static List<SAMLAccountVerification> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<SAMLAccountVerification>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SAMLAccountVerification>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SAMLAccountVerification.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class SAMLAccountVerificationStatusEnum {
  ...
  static SAMLAccountVerificationStatusEnum? fromJson(dynamic value) => SAMLAccountVerificationStatusEnumTypeTransformer().decode(value);

  static List<SAMLAccountVerificationStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class SAMLAccountVerificationStatusEnumTypeTransformer {
  factory SAMLAccountVerificationStatusEnumTypeTransformer() => _instance ??= const SAMLAccountVerificationStatusEnumTypeTransformer._();
  ...
  SAMLAccountVerificationStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'unverified': return SAMLAccountVerificationStatusEnum.unverified;
        case r'verified': return SAMLAccountVerificationStatusEnum.verified;
        case r'expired': return SAMLAccountVerificationStatusEnum.expired;
        default:
          if (!allowNull) {
...
class SAMLAccountVerificationStrategyEnum {
  ...
  static SAMLAccountVerificationStrategyEnum? fromJson(dynamic value) => SAMLAccountVerificationStrategyEnumTypeTransformer().decode(value);

  static List<SAMLAccountVerificationStrategyEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class SAMLAccountVerificationStrategyEnumTypeTransformer {
  factory SAMLAccountVerificationStrategyEnumTypeTransformer() => _instance ??= const SAMLAccountVerificationStrategyEnumTypeTransformer._();
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  SAMLAccountVerificationStrategyEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'ticket': return SAMLAccountVerificationStrategyEnum.ticket;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
