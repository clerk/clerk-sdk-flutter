...
class UpdateEmailAddressRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UpdateEmailAddressRequest &&
  ...
  @override
  String toString() => 'UpdateEmailAddressRequest[verified=$verified, primary=$primary]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UpdateEmailAddressRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UpdateEmailAddressRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UpdateEmailAddressRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<UpdateEmailAddressRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UpdateEmailAddressRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UpdateEmailAddressRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
