...
class WaitlistEntry {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is WaitlistEntry &&
    other.object == object &&
    other.id == id &&
  ...
  @override
  String toString() => 'WaitlistEntry[object=$object, id=$id, emailAddress=$emailAddress, status=$status, isLocked=$isLocked, createdAt=$createdAt, updatedAt=$updatedAt, invitation=$invitation]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "WaitlistEntry[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "WaitlistEntry[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<WaitlistEntry> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<WaitlistEntry>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<WaitlistEntry>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = WaitlistEntry.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class WaitlistEntryObjectEnum {
  ...
  static WaitlistEntryObjectEnum? fromJson(dynamic value) => WaitlistEntryObjectEnumTypeTransformer().decode(value);

  static List<WaitlistEntryObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class WaitlistEntryObjectEnumTypeTransformer {
  factory WaitlistEntryObjectEnumTypeTransformer() => _instance ??= const WaitlistEntryObjectEnumTypeTransformer._();
  ...
  WaitlistEntryObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'waitlist_entry': return WaitlistEntryObjectEnum.waitlistEntry;
        default:
          if (!allowNull) {
...
class WaitlistEntryStatusEnum {
  ...
  static WaitlistEntryStatusEnum? fromJson(dynamic value) => WaitlistEntryStatusEnumTypeTransformer().decode(value);

  static List<WaitlistEntryStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class WaitlistEntryStatusEnumTypeTransformer {
  factory WaitlistEntryStatusEnumTypeTransformer() => _instance ??= const WaitlistEntryStatusEnumTypeTransformer._();
  ...
  WaitlistEntryStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'pending': return WaitlistEntryStatusEnum.pending;
        case r'invited': return WaitlistEntryStatusEnum.invited;
        case r'rejected': return WaitlistEntryStatusEnum.rejected;
        case r'completed': return WaitlistEntryStatusEnum.completed;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
