...
class SchemasSAMLConnection {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SchemasSAMLConnection &&
    other.object == object &&
    other.id == id &&
    other.name == name &&
    other.domain == domain &&
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SchemasSAMLConnection[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SchemasSAMLConnection[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return SchemasSAMLConnection(
        ...
        attributeMapping: SAMLConnectionAttributeMapping.fromJson(json[r'attribute_mapping']),
  ...
  static List<SchemasSAMLConnection> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<SchemasSAMLConnection>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SchemasSAMLConnection>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SchemasSAMLConnection.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class SchemasSAMLConnectionObjectEnum {
  ...
  static const samlConnection = SchemasSAMLConnectionObjectEnum._(r'saml_connection');
  ...
  static SchemasSAMLConnectionObjectEnum? fromJson(dynamic value) => SchemasSAMLConnectionObjectEnumTypeTransformer().decode(value);

  static List<SchemasSAMLConnectionObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class SchemasSAMLConnectionObjectEnumTypeTransformer {
  factory SchemasSAMLConnectionObjectEnumTypeTransformer() => _instance ??= const SchemasSAMLConnectionObjectEnumTypeTransformer._();
  ...
  SchemasSAMLConnectionObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'saml_connection': return SchemasSAMLConnectionObjectEnum.samlConnection;
        default:
          if (!allowNull) {
