...
class UpdateSAMLConnectionRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UpdateSAMLConnectionRequest &&
    other.name == name &&
    other.domain == domain &&
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UpdateSAMLConnectionRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UpdateSAMLConnectionRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return UpdateSAMLConnectionRequest(
        ...
        attributeMapping: UpdateSAMLConnectionRequestAttributeMapping.fromJson(json[r'attribute_mapping']),
  ...
  static List<UpdateSAMLConnectionRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<UpdateSAMLConnectionRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UpdateSAMLConnectionRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UpdateSAMLConnectionRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
