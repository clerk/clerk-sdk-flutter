...
class TotalCount {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TotalCount &&
    other.object == object &&
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TotalCount[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TotalCount[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<TotalCount> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<TotalCount>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TotalCount>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TotalCount.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class TotalCountObjectEnum {
  ...
  static TotalCountObjectEnum? fromJson(dynamic value) => TotalCountObjectEnumTypeTransformer().decode(value);

  static List<TotalCountObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class TotalCountObjectEnumTypeTransformer {
  factory TotalCountObjectEnumTypeTransformer() => _instance ??= const TotalCountObjectEnumTypeTransformer._();
  ...
  TotalCountObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'total_count': return TotalCountObjectEnum.totalCount;
        default:
          if (!allowNull) {
