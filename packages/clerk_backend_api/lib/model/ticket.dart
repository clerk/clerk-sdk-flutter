...
class Ticket {
  ...
  @override
  String toString() => 'Ticket[status=$status, strategy=$strategy, attempts=$attempts, expireAt=$expireAt, verifiedAtClient=$verifiedAtClient]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "Ticket[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "Ticket[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<Ticket> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Ticket>[];
  ...
  static Map<String, List<Ticket>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<Ticket>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = Ticket.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class TicketStatusEnum {
  ...
  static TicketStatusEnum? fromJson(dynamic value) => TicketStatusEnumTypeTransformer().decode(value);

  static List<TicketStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class TicketStatusEnumTypeTransformer {
  factory TicketStatusEnumTypeTransformer() => _instance ??= const TicketStatusEnumTypeTransformer._();
  ...
  TicketStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'unverified': return TicketStatusEnum.unverified;
        case r'verified': return TicketStatusEnum.verified;
        case r'expired': return TicketStatusEnum.expired;
        default:
          if (!allowNull) {
...
class TicketStrategyEnum {
  ...
  static TicketStrategyEnum? fromJson(dynamic value) => TicketStrategyEnumTypeTransformer().decode(value);

  static List<TicketStrategyEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class TicketStrategyEnumTypeTransformer {
  factory TicketStrategyEnumTypeTransformer() => _instance ??= const TicketStrategyEnumTypeTransformer._();
  ...
  TicketStrategyEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'ticket': return TicketStrategyEnum.ticket;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
