# openapi.model.UpdateOAuthApplicationRequest
...
**consentScreenEnabled** | **bool** | True to enable a consent screen to display in the authentication flow. This cannot be disabled for dynamically registered OAuth Applications. | [optional] 
**pkceRequired** | **bool** | True to require the Proof Key of Code Exchange (PKCE) flow. | [optional] 
