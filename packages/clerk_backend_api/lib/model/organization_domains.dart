...
class OrganizationDomains {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is OrganizationDomains &&
  ...
  @override
  String toString() => 'OrganizationDomains[data=$data, totalCount=$totalCount]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "OrganizationDomains[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "OrganizationDomains[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<OrganizationDomains> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<OrganizationDomains>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<OrganizationDomains>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = OrganizationDomains.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
