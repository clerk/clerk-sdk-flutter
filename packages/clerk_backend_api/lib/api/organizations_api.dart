...
class OrganizationsApi {
  ...
  Future<http.Response> createOrganizationWithHttpInfo({ CreateOrganizationRequest? createOrganizationRequest, }) async {
  ...
  Future<Organization?> createOrganization({ CreateOrganizationRequest? createOrganizationRequest, }) async {
    final response = await createOrganizationWithHttpInfo( createOrganizationRequest: createOrganizationRequest, );
  ...
  Future<http.Response> deleteOrganizationWithHttpInfo(String organizationId,) async {
    // ignore: prefer_const_declarations
  ...
  Future<http.Response> deleteOrganizationLogoWithHttpInfo(String organizationId,) async {
    // ignore: prefer_const_declarations
  ...
  Future<Organization?> deleteOrganizationLogo(String organizationId,) async {
    final response = await deleteOrganizationLogoWithHttpInfo(organizationId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<http.Response> getOrganizationWithHttpInfo(String organizationId, { bool? includeMembersCount, bool? includeMissingMemberWithElevatedPermissions, }) async {
    // ignore: prefer_const_declarations
    final path = r'/organizations/{organization_id}'
      .replaceAll('{organization_id}', organizationId);
    ...
    if (includeMembersCount != null) {
      queryParams.addAll(_queryParams('', 'include_members_count', includeMembersCount));
    }
    if (includeMissingMemberWithElevatedPermissions != null) {
      queryParams.addAll(_queryParams('', 'include_missing_member_with_elevated_permissions', includeMissingMemberWithElevatedPermissions));
    }
  ...
  Future<Organization?> getOrganization(String organizationId, { bool? includeMembersCount, bool? includeMissingMemberWithElevatedPermissions, }) async {
    final response = await getOrganizationWithHttpInfo(organizationId,  includeMembersCount: includeMembersCount, includeMissingMemberWithElevatedPermissions: includeMissingMemberWithElevatedPermissions, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<http.Response> listOrganizationsWithHttpInfo({ bool? includeMembersCount, bool? includeMissingMemberWithElevatedPermissions, String? query, List<String>? userId, List<String>? organizationId, String? orderBy, int? limit, int? offset, }) async {
    // ignore: prefer_const_declarations
    final path = r'/organizations';
  ...
  Future<Organizations?> listOrganizations({ bool? includeMembersCount, bool? includeMissingMemberWithElevatedPermissions, String? query, List<String>? userId, List<String>? organizationId, String? orderBy, int? limit, int? offset, }) async {
    final response = await listOrganizationsWithHttpInfo( includeMembersCount: includeMembersCount, includeMissingMemberWithElevatedPermissions: includeMissingMemberWithElevatedPermissions, query: query, userId: userId, organizationId: organizationId, orderBy: orderBy, limit: limit, offset: offset, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<http.Response> mergeOrganizationMetadataWithHttpInfo(String organizationId, MergeOrganizationMetadataRequest mergeOrganizationMetadataRequest,) async {
    // ignore: prefer_const_declarations
  ...
  Future<Organization?> mergeOrganizationMetadata(String organizationId, MergeOrganizationMetadataRequest mergeOrganizationMetadataRequest,) async {
    final response = await mergeOrganizationMetadataWithHttpInfo(organizationId, mergeOrganizationMetadataRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<http.Response> updateOrganizationWithHttpInfo(String organizationId, UpdateOrganizationRequest updateOrganizationRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/organizations/{organization_id}'
      .replaceAll('{organization_id}', organizationId);
  ...
  Future<Organization?> updateOrganization(String organizationId, UpdateOrganizationRequest updateOrganizationRequest,) async {
    final response = await updateOrganizationWithHttpInfo(organizationId, updateOrganizationRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<http.Response> uploadOrganizationLogoWithHttpInfo(String organizationId, http.MultipartFile file, { String? uploaderUserId, }) async {
    // ignore: prefer_const_declarations
    final path = r'/organizations/{organization_id}/logo'
      .replaceAll('{organization_id}', organizationId);
  ...
  /// * [String] uploaderUserId:
  ///   The ID of the user that will be credited with the image upload.
  Future<OrganizationWithLogo?> uploadOrganizationLogo(String organizationId, http.MultipartFile file, { String? uploaderUserId, }) async {
    final response = await uploadOrganizationLogoWithHttpInfo(organizationId, file,  uploaderUserId: uploaderUserId, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'OrganizationWithLogo',) as OrganizationWithLogo;
