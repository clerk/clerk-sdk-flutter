...
class UpdatePhoneNumberRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UpdatePhoneNumberRequest &&
  ...
  @override
  String toString() => 'UpdatePhoneNumberRequest[verified=$verified, primary=$primary, reservedForSecondFactor=$reservedForSecondFactor]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UpdatePhoneNumberRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UpdatePhoneNumberRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UpdatePhoneNumberRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<UpdatePhoneNumberRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UpdatePhoneNumberRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UpdatePhoneNumberRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
