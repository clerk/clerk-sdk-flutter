...
class CreateInvitationRequest {
  ...
  @override
  String toString() => 'CreateInvitationRequest[emailAddress=$emailAddress, publicMetadata=$publicMetadata, redirectUrl=$redirectUrl, notify=$notify, ignoreExisting=$ignoreExisting, expiresInDays=$expiresInDays, templateSlug=$templateSlug]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CreateInvitationRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CreateInvitationRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return CreateInvitationRequest(
        ...
        publicMetadata: mapCastOfType<String, Object>(json, r'public_metadata') ?? const {},
        ...
        templateSlug: CreateInvitationRequestTemplateSlugEnum.fromJson(json[r'template_slug']),
      );
    }
    return null;
  }

  static List<CreateInvitationRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<CreateInvitationRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CreateInvitationRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CreateInvitationRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class CreateInvitationRequestTemplateSlugEnum {
  ...
  static const invitation = CreateInvitationRequestTemplateSlugEnum._(r'invitation');
  static const waitlistInvitation = CreateInvitationRequestTemplateSlugEnum._(r'waitlist_invitation');
  ...
  static CreateInvitationRequestTemplateSlugEnum? fromJson(dynamic value) => CreateInvitationRequestTemplateSlugEnumTypeTransformer().decode(value);

  static List<CreateInvitationRequestTemplateSlugEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class CreateInvitationRequestTemplateSlugEnumTypeTransformer {
  factory CreateInvitationRequestTemplateSlugEnumTypeTransformer() => _instance ??= const CreateInvitationRequestTemplateSlugEnumTypeTransformer._();
  ...
  CreateInvitationRequestTemplateSlugEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'invitation': return CreateInvitationRequestTemplateSlugEnum.invitation;
        case r'waitlist_invitation': return CreateInvitationRequestTemplateSlugEnum.waitlistInvitation;
        default:
          if (!allowNull) {
