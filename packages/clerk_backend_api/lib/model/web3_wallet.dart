...
class Web3Wallet {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Web3Wallet &&
    other.id == id &&
    other.object == object &&
  ...
  @override
  String toString() => 'Web3Wallet[id=$id, object=$object, web3Wallet=$web3Wallet, verification=$verification, createdAt=$createdAt, updatedAt=$updatedAt]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "Web3Wallet[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "Web3Wallet[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<Web3Wallet> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<Web3Wallet>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<Web3Wallet>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = Web3Wallet.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class Web3WalletObjectEnum {
  ...
  static Web3WalletObjectEnum? fromJson(dynamic value) => Web3WalletObjectEnumTypeTransformer().decode(value);

  static List<Web3WalletObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class Web3WalletObjectEnumTypeTransformer {
  factory Web3WalletObjectEnumTypeTransformer() => _instance ??= const Web3WalletObjectEnumTypeTransformer._();
  ...
  Web3WalletObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'web3_wallet': return Web3WalletObjectEnum.web3Wallet;
        default:
          if (!allowNull) {
