...
class SignUpVerification {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SignUpVerification &&
  ...
  @override
  String toString() => 'SignUpVerification[nextAction=$nextAction, supportedStrategies=$supportedStrategies]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SignUpVerification[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SignUpVerification[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return SignUpVerification(
        nextAction: SignUpVerificationNextActionEnum.fromJson(json[r'next_action']),
        supportedStrategies: json[r'supported_strategies'] is Iterable
            ? (json[r'supported_strategies'] as Iterable).cast<String>().toList(growable: false)
            : const [],
      );
    }
    return null;
  ...
  static List<SignUpVerification> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<SignUpVerification>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SignUpVerification>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SignUpVerification.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class SignUpVerificationNextActionEnum {
  ...
  static const needsPrepare = SignUpVerificationNextActionEnum._(r'needs_prepare');
  static const needsAttempt = SignUpVerificationNextActionEnum._(r'needs_attempt');
  ...
  static SignUpVerificationNextActionEnum? fromJson(dynamic value) => SignUpVerificationNextActionEnumTypeTransformer().decode(value);

  static List<SignUpVerificationNextActionEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class SignUpVerificationNextActionEnumTypeTransformer {
  factory SignUpVerificationNextActionEnumTypeTransformer() => _instance ??= const SignUpVerificationNextActionEnumTypeTransformer._();
  ...
  SignUpVerificationNextActionEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'needs_prepare': return SignUpVerificationNextActionEnum.needsPrepare;
        case r'needs_attempt': return SignUpVerificationNextActionEnum.needsAttempt;
        case r'': return SignUpVerificationNextActionEnum.empty;
        default:
          if (!allowNull) {
