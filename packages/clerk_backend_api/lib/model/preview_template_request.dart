...
class PreviewTemplateRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PreviewTemplateRequest &&
  ...
  @override
  String toString() => 'PreviewTemplateRequest[subject=$subject, body=$body, fromEmailName=$fromEmailName, replyToEmailName=$replyToEmailName]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PreviewTemplateRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PreviewTemplateRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PreviewTemplateRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<PreviewTemplateRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PreviewTemplateRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PreviewTemplateRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
