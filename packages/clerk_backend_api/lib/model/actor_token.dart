...
class ActorToken {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ActorToken &&
    other.object == object &&
    other.id == id &&
    other.status == status &&
    other.userId == userId &&
  ...
  @override
  String toString() => 'ActorToken[object=$object, id=$id, status=$status, userId=$userId, actor=$actor, token=$token, url=$url, createdAt=$createdAt, updatedAt=$updatedAt]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ActorToken[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ActorToken[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ActorToken> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<ActorToken>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ActorToken>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ActorToken.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class ActorTokenObjectEnum {
  ...
  static ActorTokenObjectEnum? fromJson(dynamic value) => ActorTokenObjectEnumTypeTransformer().decode(value);

  static List<ActorTokenObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class ActorTokenObjectEnumTypeTransformer {
  factory ActorTokenObjectEnumTypeTransformer() => _instance ??= const ActorTokenObjectEnumTypeTransformer._();
  ...
  ActorTokenObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'actor_token': return ActorTokenObjectEnum.actorToken;
        default:
          if (!allowNull) {
...
class ActorTokenStatusEnum {
  ...
  static ActorTokenStatusEnum? fromJson(dynamic value) => ActorTokenStatusEnumTypeTransformer().decode(value);

  static List<ActorTokenStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class ActorTokenStatusEnumTypeTransformer {
  factory ActorTokenStatusEnumTypeTransformer() => _instance ??= const ActorTokenStatusEnumTypeTransformer._();
  ...
  ActorTokenStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'pending': return ActorTokenStatusEnum.pending;
        case r'accepted': return ActorTokenStatusEnum.accepted;
        case r'revoked': return ActorTokenStatusEnum.revoked;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
