...
class OrganizationDomainVerification {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is OrganizationDomainVerification &&
    other.status == status &&
  ...
  @override
  String toString() => 'OrganizationDomainVerification[status=$status, strategy=$strategy, attempts=$attempts, expireAt=$expireAt]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "OrganizationDomainVerification[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "OrganizationDomainVerification[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return OrganizationDomainVerification(
        status: OrganizationDomainVerificationStatusEnum.fromJson(json[r'status'])!,
  ...
  static List<OrganizationDomainVerification> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<OrganizationDomainVerification>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<OrganizationDomainVerification>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = OrganizationDomainVerification.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class OrganizationDomainVerificationStatusEnum {
  ...
  static const unverified = OrganizationDomainVerificationStatusEnum._(r'unverified');
  static const verified = OrganizationDomainVerificationStatusEnum._(r'verified');
  ...
  static OrganizationDomainVerificationStatusEnum? fromJson(dynamic value) => OrganizationDomainVerificationStatusEnumTypeTransformer().decode(value);

  static List<OrganizationDomainVerificationStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class OrganizationDomainVerificationStatusEnumTypeTransformer {
  factory OrganizationDomainVerificationStatusEnumTypeTransformer() => _instance ??= const OrganizationDomainVerificationStatusEnumTypeTransformer._();
  ...
  OrganizationDomainVerificationStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'unverified': return OrganizationDomainVerificationStatusEnum.unverified;
        case r'verified': return OrganizationDomainVerificationStatusEnum.verified;
        default:
          if (!allowNull) {
