...
class ProxyCheck {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ProxyCheck &&
    other.object == object &&
    other.id == id &&
  ...
  @override
  String toString() => 'ProxyCheck[object=$object, id=$id, domainId=$domainId, lastRunAt=$lastRunAt, proxyUrl=$proxyUrl, successful=$successful, createdAt=$createdAt, updatedAt=$updatedAt]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ProxyCheck[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ProxyCheck[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ProxyCheck> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<ProxyCheck>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ProxyCheck>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ProxyCheck.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class ProxyCheckObjectEnum {
  ...
  static ProxyCheckObjectEnum? fromJson(dynamic value) => ProxyCheckObjectEnumTypeTransformer().decode(value);

  static List<ProxyCheckObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class ProxyCheckObjectEnumTypeTransformer {
  factory ProxyCheckObjectEnumTypeTransformer() => _instance ??= const ProxyCheckObjectEnumTypeTransformer._();
  ...
  ProxyCheckObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'proxy_check': return ProxyCheckObjectEnum.proxyCheck;
        default:
          if (!allowNull) {
