...
class SvixURL {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SvixURL &&
    other.svixUrl == svixUrl;
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SvixURL[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SvixURL[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SvixURL> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<SvixURL>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SvixURL>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SvixURL.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
