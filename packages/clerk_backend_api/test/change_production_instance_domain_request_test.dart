...
// tests for ChangeProductionInstanceDomainRequest
void main() {
  // final instance = ChangeProductionInstanceDomainRequest();

  group('test ChangeProductionInstanceDomainRequest', () {
    // The new home URL of the production instance e.g. https://www.example.com
    // String homeUrl
    test('to test the property `homeUrl`', () async {
      // TODO
    });
