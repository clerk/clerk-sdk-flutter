...
class ChangeProductionInstanceDomainRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ChangeProductionInstanceDomainRequest &&
  ...
  @override
  String toString() => 'ChangeProductionInstanceDomainRequest[homeUrl=$homeUrl, isSecondary=$isSecondary]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ChangeProductionInstanceDomainRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ChangeProductionInstanceDomainRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ChangeProductionInstanceDomainRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, ChangeProductionInstanceDomainRequest> mapFromJson(dynamic json) {
    final map = <String, ChangeProductionInstanceDomainRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ChangeProductionInstanceDomainRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<ChangeProductionInstanceDomainRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ChangeProductionInstanceDomainRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ChangeProductionInstanceDomainRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
