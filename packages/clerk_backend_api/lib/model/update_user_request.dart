...
class UpdateUserRequest {
  ...
  bool operator ==(Object other) => identical(this, other) || other is UpdateUserRequest &&
    ...
    other.notifyPrimaryEmailAddressChanged == notifyPrimaryEmailAddressChanged &&
  ...
  int get hashCode =>
    ...
    (notifyPrimaryEmailAddressChanged == null ? 0 : notifyPrimaryEmailAddressChanged!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.notifyPrimaryEmailAddressChanged != null) {
      json[r'notify_primary_email_address_changed'] = this.notifyPrimaryEmailAddressChanged;
    } else {
  ...
  static UpdateUserRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return UpdateUserRequest(
        ...
        notifyPrimaryEmailAddressChanged: mapValueOfType<bool>(json, r'notify_primary_email_address_changed') ?? false,
        ...
        signOutOfOtherSessions: mapValueOfType<bool>(json, r'sign_out_of_other_sessions'),
