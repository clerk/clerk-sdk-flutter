...
class SessionActivityResponse {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SessionActivityResponse &&
    other.object == object &&
    other.id == id &&
  ...
  @override
  String toString() => 'SessionActivityResponse[object=$object, id=$id, deviceType=$deviceType, isMobile=$isMobile, browserName=$browserName, browserVersion=$browserVersion, ipAddress=$ipAddress, city=$city, country=$country]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SessionActivityResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SessionActivityResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SessionActivityResponse> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<SessionActivityResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SessionActivityResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SessionActivityResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
