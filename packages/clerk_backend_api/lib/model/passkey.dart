...
class Passkey {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Passkey &&
    other.status == status &&
  ...
  @override
  String toString() => 'Passkey[status=$status, strategy=$strategy, nonce=$nonce, message=$message, attempts=$attempts, expireAt=$expireAt, verifiedAtClient=$verifiedAtClient]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "Passkey[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "Passkey[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<Passkey> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<Passkey>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<Passkey>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = Passkey.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class PasskeyStatusEnum {
  ...
  static PasskeyStatusEnum? fromJson(dynamic value) => PasskeyStatusEnumTypeTransformer().decode(value);

  static List<PasskeyStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class PasskeyStatusEnumTypeTransformer {
  factory PasskeyStatusEnumTypeTransformer() => _instance ??= const PasskeyStatusEnumTypeTransformer._();
  ...
  PasskeyStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'verified': return PasskeyStatusEnum.verified;
        default:
          if (!allowNull) {
...
class PasskeyStrategyEnum {
  ...
  static PasskeyStrategyEnum? fromJson(dynamic value) => PasskeyStrategyEnumTypeTransformer().decode(value);

  static List<PasskeyStrategyEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class PasskeyStrategyEnumTypeTransformer {
  factory PasskeyStrategyEnumTypeTransformer() => _instance ??= const PasskeyStrategyEnumTypeTransformer._();
  ...
  PasskeyStrategyEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'passkey': return PasskeyStrategyEnum.passkey;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
...
class PasskeyNonceEnum {
  ...
  static PasskeyNonceEnum? fromJson(dynamic value) => PasskeyNonceEnumTypeTransformer().decode(value);

  static List<PasskeyNonceEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class PasskeyNonceEnumTypeTransformer {
  factory PasskeyNonceEnumTypeTransformer() => _instance ??= const PasskeyNonceEnumTypeTransformer._();
  ...
  PasskeyNonceEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'nonce': return PasskeyNonceEnum.nonce;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
