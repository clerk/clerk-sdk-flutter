...
class Web3WalletVerification {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Web3WalletVerification &&
    other.status == status &&
  ...
  @override
  String toString() => 'Web3WalletVerification[status=$status, strategy=$strategy, nonce=$nonce, message=$message, attempts=$attempts, expireAt=$expireAt, verifiedAtClient=$verifiedAtClient]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "Web3WalletVerification[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "Web3WalletVerification[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return Web3WalletVerification(
        ...
        strategy: Web3WalletVerificationStrategyEnum.fromJson(json[r'strategy'])!,
  ...
  static List<Web3WalletVerification> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<Web3WalletVerification>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<Web3WalletVerification>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = Web3WalletVerification.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class Web3WalletVerificationStatusEnum {
  ...
  static Web3WalletVerificationStatusEnum? fromJson(dynamic value) => Web3WalletVerificationStatusEnumTypeTransformer().decode(value);

  static List<Web3WalletVerificationStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class Web3WalletVerificationStatusEnumTypeTransformer {
  factory Web3WalletVerificationStatusEnumTypeTransformer() => _instance ??= const Web3WalletVerificationStatusEnumTypeTransformer._();
  ...
  Web3WalletVerificationStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'verified': return Web3WalletVerificationStatusEnum.verified;
        default:
          if (!allowNull) {
...
class Web3WalletVerificationStrategyEnum {
  ...
  static Web3WalletVerificationStrategyEnum? fromJson(dynamic value) => Web3WalletVerificationStrategyEnumTypeTransformer().decode(value);

  static List<Web3WalletVerificationStrategyEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class Web3WalletVerificationStrategyEnumTypeTransformer {
  factory Web3WalletVerificationStrategyEnumTypeTransformer() => _instance ??= const Web3WalletVerificationStrategyEnumTypeTransformer._();
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  Web3WalletVerificationStrategyEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'admin': return Web3WalletVerificationStrategyEnum.admin;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
