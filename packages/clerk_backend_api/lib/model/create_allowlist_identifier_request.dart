...
class CreateAllowlistIdentifierRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreateAllowlistIdentifierRequest &&
  ...
  @override
  String toString() => 'CreateAllowlistIdentifierRequest[identifier=$identifier, notify=$notify]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CreateAllowlistIdentifierRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CreateAllowlistIdentifierRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CreateAllowlistIdentifierRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, CreateAllowlistIdentifierRequest> mapFromJson(dynamic json) {
  ...
  static Map<String, List<CreateAllowlistIdentifierRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CreateAllowlistIdentifierRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CreateAllowlistIdentifierRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
