...
class OrganizationWithLogo {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is OrganizationWithLogo &&
    other.object == object &&
    other.id == id &&
    other.name == name &&
    other.slug == slug &&
    other.membersCount == membersCount &&
    other.missingMemberWithElevatedPermissions == missingMemberWithElevatedPermissions &&
  ...
  int get hashCode =>
    ...
    (missingMemberWithElevatedPermissions == null ? 0 : missingMemberWithElevatedPermissions!.hashCode) +
    (pendingInvitationsCount == null ? 0 : pendingInvitationsCount!.hashCode) +
  ...
  @override
  String toString() => 'OrganizationWithLogo[object=$object, id=$id, name=$name, slug=$slug, membersCount=$membersCount, missingMemberWithElevatedPermissions=$missingMemberWithElevatedPermissions, pendingInvitationsCount=$pendingInvitationsCount, maxAllowedMemberships=$maxAllowedMemberships, adminDeleteEnabled=$adminDeleteEnabled, publicMetadata=$publicMetadata, privateMetadata=$privateMetadata, createdBy=$createdBy, createdAt=$createdAt, updatedAt=$updatedAt, logoUrl=$logoUrl, imageUrl=$imageUrl, hasImage=$hasImage]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.missingMemberWithElevatedPermissions != null) {
      json[r'missing_member_with_elevated_permissions'] = this.missingMemberWithElevatedPermissions;
    } else {
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "OrganizationWithLogo[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "OrganizationWithLogo[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return OrganizationWithLogo(
        ...
        missingMemberWithElevatedPermissions: mapValueOfType<bool>(json, r'missing_member_with_elevated_permissions'),
        pendingInvitationsCount: mapValueOfType<int>(json, r'pending_invitations_count'),
        ...
        privateMetadata: mapCastOfType<String, Object>(json, r'private_metadata')!,
  ...
  static List<OrganizationWithLogo> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<OrganizationWithLogo>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<OrganizationWithLogo>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = OrganizationWithLogo.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class OrganizationWithLogoObjectEnum {
  ...
  static OrganizationWithLogoObjectEnum? fromJson(dynamic value) => OrganizationWithLogoObjectEnumTypeTransformer().decode(value);

  static List<OrganizationWithLogoObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class OrganizationWithLogoObjectEnumTypeTransformer {
  factory OrganizationWithLogoObjectEnumTypeTransformer() => _instance ??= const OrganizationWithLogoObjectEnumTypeTransformer._();
  ...
  OrganizationWithLogoObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'organization': return OrganizationWithLogoObjectEnum.organization;
        default:
          if (!allowNull) {
