...
class UpdateInstanceAuthConfig200Response {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UpdateInstanceAuthConfig200Response &&
    other.object == object &&
    other.id == id &&
  ...
  int get hashCode =>
    ...
    (enhancedEmailDeliverability == null ? 0 : enhancedEmailDeliverability!.hashCode);

  @override
  String toString() => 'UpdateInstanceAuthConfig200Response[object=$object, id=$id, restrictedToAllowlist=$restrictedToAllowlist, fromEmailAddress=$fromEmailAddress, progressiveSignUp=$progressiveSignUp, enhancedEmailDeliverability=$enhancedEmailDeliverability]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UpdateInstanceAuthConfig200Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UpdateInstanceAuthConfig200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return UpdateInstanceAuthConfig200Response(
        object: UpdateInstanceAuthConfig200ResponseObjectEnum.fromJson(json[r'object']),
        id: mapValueOfType<String>(json, r'id'),
        restrictedToAllowlist: mapValueOfType<bool>(json, r'restricted_to_allowlist'),
        ...
        enhancedEmailDeliverability: mapValueOfType<bool>(json, r'enhanced_email_deliverability'),
      );
    }
    return null;
  }

  static List<UpdateInstanceAuthConfig200Response> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, UpdateInstanceAuthConfig200Response> mapFromJson(dynamic json) {
  ...
  static Map<String, List<UpdateInstanceAuthConfig200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UpdateInstanceAuthConfig200Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UpdateInstanceAuthConfig200Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class UpdateInstanceAuthConfig200ResponseObjectEnum {
  ...
  static const instanceSettings = UpdateInstanceAuthConfig200ResponseObjectEnum._(r'instance_settings');
  ...
  static UpdateInstanceAuthConfig200ResponseObjectEnum? fromJson(dynamic value) => UpdateInstanceAuthConfig200ResponseObjectEnumTypeTransformer().decode(value);

  static List<UpdateInstanceAuthConfig200ResponseObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <UpdateInstanceAuthConfig200ResponseObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UpdateInstanceAuthConfig200ResponseObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
class UpdateInstanceAuthConfig200ResponseObjectEnumTypeTransformer {
  factory UpdateInstanceAuthConfig200ResponseObjectEnumTypeTransformer() => _instance ??= const UpdateInstanceAuthConfig200ResponseObjectEnumTypeTransformer._();

  const UpdateInstanceAuthConfig200ResponseObjectEnumTypeTransformer._();

  String encode(UpdateInstanceAuthConfig200ResponseObjectEnum data) => data.value;
  ...
  UpdateInstanceAuthConfig200ResponseObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'instance_settings': return UpdateInstanceAuthConfig200ResponseObjectEnum.instanceSettings;
        default:
          if (!allowNull) {
  ...
  static UpdateInstanceAuthConfig200ResponseObjectEnumTypeTransformer? _instance;
}
