...
class SignUp {
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SignUp[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SignUp[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return SignUp(
        ...
        requiredFields: json[r'required_fields'] is Iterable
            ? (json[r'required_fields'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        optionalFields: json[r'optional_fields'] is Iterable
            ? (json[r'optional_fields'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        ...
        unverifiedFields: json[r'unverified_fields'] is Iterable
            ? (json[r'unverified_fields'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        ...
        unsafeMetadata: mapCastOfType<String, Object>(json, r'unsafe_metadata') ?? const {},
  ...
  static List<SignUp> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SignUp>[];
  ...
  static Map<String, List<SignUp>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SignUp>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SignUp.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class SignUpObjectEnum {
  ...
  static SignUpObjectEnum? fromJson(dynamic value) => SignUpObjectEnumTypeTransformer().decode(value);

  static List<SignUpObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class SignUpObjectEnumTypeTransformer {
  factory SignUpObjectEnumTypeTransformer() => _instance ??= const SignUpObjectEnumTypeTransformer._();
  ...
  SignUpObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'sign_up_attempt': return SignUpObjectEnum.signUpAttempt;
        default:
          if (!allowNull) {
...
class SignUpStatusEnum {
  ...
  static const missingRequirements = SignUpStatusEnum._(r'missing_requirements');
  ...
  static SignUpStatusEnum? fromJson(dynamic value) => SignUpStatusEnumTypeTransformer().decode(value);

  static List<SignUpStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class SignUpStatusEnumTypeTransformer {
  factory SignUpStatusEnumTypeTransformer() => _instance ??= const SignUpStatusEnumTypeTransformer._();
  ...
  SignUpStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'missing_requirements': return SignUpStatusEnum.missingRequirements;
        case r'complete': return SignUpStatusEnum.complete;
        case r'abandoned': return SignUpStatusEnum.abandoned;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
