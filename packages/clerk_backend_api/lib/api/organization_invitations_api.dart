...
class OrganizationInvitationsApi {
  OrganizationInvitationsApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<http.Response> createOrganizationInvitationWithHttpInfo(String organizationId, { CreateOrganizationInvitationRequest? createOrganizationInvitationRequest, }) async {
  ...
  Future<OrganizationInvitation?> createOrganizationInvitation(String organizationId, { CreateOrganizationInvitationRequest? createOrganizationInvitationRequest, }) async {
    final response = await createOrganizationInvitationWithHttpInfo(organizationId,  createOrganizationInvitationRequest: createOrganizationInvitationRequest, );
  ...
  Future<http.Response> createOrganizationInvitationBulkWithHttpInfo(String organizationId, List<CreateOrganizationInvitationRequest> createOrganizationInvitationRequest,) async {
    // ignore: prefer_const_declarations
  ...
  Future<OrganizationInvitations?> createOrganizationInvitationBulk(String organizationId, List<CreateOrganizationInvitationRequest> createOrganizationInvitationRequest,) async {
    final response = await createOrganizationInvitationBulkWithHttpInfo(organizationId, createOrganizationInvitationRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'OrganizationInvitations',) as OrganizationInvitations;
  ...
  Future<http.Response> getOrganizationInvitationWithHttpInfo(String organizationId, String invitationId,) async {
    // ignore: prefer_const_declarations
  ...
  Future<OrganizationInvitation?> getOrganizationInvitation(String organizationId, String invitationId,) async {
    final response = await getOrganizationInvitationWithHttpInfo(organizationId, invitationId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<http.Response> listInstanceOrganizationInvitationsWithHttpInfo({ String? orderBy, String? status, String? query, int? limit, int? offset, }) async {
    // ignore: prefer_const_declarations
  ...
  Future<OrganizationInvitationsWithPublicOrganizationData?> listInstanceOrganizationInvitations({ String? orderBy, String? status, String? query, int? limit, int? offset, }) async {
    final response = await listInstanceOrganizationInvitationsWithHttpInfo( orderBy: orderBy, status: status, query: query, limit: limit, offset: offset, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [int] offset:
  ///   Skip the first `offset` results when paginating. Needs to be an integer greater or equal to zero. To be used in conjunction with `limit`.
  Future<http.Response> listOrganizationInvitationsWithHttpInfo(String organizationId, { String? status, int? limit, int? offset, }) async {
    // ignore: prefer_const_declarations
    final path = r'/organizations/{organization_id}/invitations'
      .replaceAll('{organization_id}', organizationId);
  ...
  Future<OrganizationInvitations?> listOrganizationInvitations(String organizationId, { String? status, int? limit, int? offset, }) async {
    final response = await listOrganizationInvitationsWithHttpInfo(organizationId,  status: status, limit: limit, offset: offset, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [int] offset:
  ///   Skip the first `offset` results when paginating. Needs to be an integer greater or equal to zero. To be used in conjunction with `limit`.
  Future<http.Response> listPendingOrganizationInvitationsWithHttpInfo(String organizationId, { int? limit, int? offset, }) async {
    // ignore: prefer_const_declarations
  ...
  Future<OrganizationInvitations?> listPendingOrganizationInvitations(String organizationId, { int? limit, int? offset, }) async {
    final response = await listPendingOrganizationInvitationsWithHttpInfo(organizationId,  limit: limit, offset: offset, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<http.Response> revokeOrganizationInvitationWithHttpInfo(String organizationId, String invitationId, { RevokeOrganizationInvitationRequest? revokeOrganizationInvitationRequest, }) async {
    // ignore: prefer_const_declarations
    final path = r'/organizations/{organization_id}/invitations/{invitation_id}/revoke'
      .replaceAll('{organization_id}', organizationId)
      .replaceAll('{invitation_id}', invitationId);
  ...
  Future<OrganizationInvitation?> revokeOrganizationInvitation(String organizationId, String invitationId, { RevokeOrganizationInvitationRequest? revokeOrganizationInvitationRequest, }) async {
    final response = await revokeOrganizationInvitationWithHttpInfo(organizationId, invitationId,  revokeOrganizationInvitationRequest: revokeOrganizationInvitationRequest, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
