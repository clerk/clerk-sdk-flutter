...
class OrganizationDomain {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is OrganizationDomain &&
    other.object == object &&
    other.id == id &&
  ...
  int get hashCode =>
    ...
    (affiliationEmailAddress == null ? 0 : affiliationEmailAddress!.hashCode) +
  ...
  @override
  String toString() => 'OrganizationDomain[object=$object, id=$id, organizationId=$organizationId, name=$name, enrollmentMode=$enrollmentMode, affiliationEmailAddress=$affiliationEmailAddress, verification=$verification, totalPendingInvitations=$totalPendingInvitations, totalPendingSuggestions=$totalPendingSuggestions, createdAt=$createdAt, updatedAt=$updatedAt]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "OrganizationDomain[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "OrganizationDomain[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return OrganizationDomain(
        ...
        enrollmentMode: OrganizationDomainEnrollmentModeEnum.fromJson(json[r'enrollment_mode'])!,
        affiliationEmailAddress: mapValueOfType<String>(json, r'affiliation_email_address'),
        verification: OrganizationDomainVerification.fromJson(json[r'verification']),
        totalPendingInvitations: mapValueOfType<int>(json, r'total_pending_invitations')!,
        totalPendingSuggestions: mapValueOfType<int>(json, r'total_pending_suggestions')!,
  ...
  static List<OrganizationDomain> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<OrganizationDomain>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<OrganizationDomain>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = OrganizationDomain.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class OrganizationDomainObjectEnum {
  ...
  static const organizationDomain = OrganizationDomainObjectEnum._(r'organization_domain');
  ...
  static OrganizationDomainObjectEnum? fromJson(dynamic value) => OrganizationDomainObjectEnumTypeTransformer().decode(value);

  static List<OrganizationDomainObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class OrganizationDomainObjectEnumTypeTransformer {
  factory OrganizationDomainObjectEnumTypeTransformer() => _instance ??= const OrganizationDomainObjectEnumTypeTransformer._();
  ...
  OrganizationDomainObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'organization_domain': return OrganizationDomainObjectEnum.organizationDomain;
        default:
          if (!allowNull) {
...
class OrganizationDomainEnrollmentModeEnum {
  ...
  static const manualInvitation = OrganizationDomainEnrollmentModeEnum._(r'manual_invitation');
  static const automaticInvitation = OrganizationDomainEnrollmentModeEnum._(r'automatic_invitation');
  static const automaticSuggestion = OrganizationDomainEnrollmentModeEnum._(r'automatic_suggestion');
  ...
  static OrganizationDomainEnrollmentModeEnum? fromJson(dynamic value) => OrganizationDomainEnrollmentModeEnumTypeTransformer().decode(value);

  static List<OrganizationDomainEnrollmentModeEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class OrganizationDomainEnrollmentModeEnumTypeTransformer {
  factory OrganizationDomainEnrollmentModeEnumTypeTransformer() => _instance ??= const OrganizationDomainEnrollmentModeEnumTypeTransformer._();
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  OrganizationDomainEnrollmentModeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'manual_invitation': return OrganizationDomainEnrollmentModeEnum.manualInvitation;
        case r'automatic_invitation': return OrganizationDomainEnrollmentModeEnum.automaticInvitation;
        case r'automatic_suggestion': return OrganizationDomainEnrollmentModeEnum.automaticSuggestion;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
