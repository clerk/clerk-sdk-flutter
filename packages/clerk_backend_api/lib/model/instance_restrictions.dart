...
class InstanceRestrictions {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is InstanceRestrictions &&
    other.object == object &&
  ...
  @override
  String toString() => 'InstanceRestrictions[object=$object, allowlist=$allowlist, blocklist=$blocklist, blockEmailSubaddresses=$blockEmailSubaddresses, blockDisposableEmailDomains=$blockDisposableEmailDomains, ignoreDotsForGmailAddresses=$ignoreDotsForGmailAddresses]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "InstanceRestrictions[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "InstanceRestrictions[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return InstanceRestrictions(
        ...
        blockEmailSubaddresses: mapValueOfType<bool>(json, r'block_email_subaddresses')!,
        blockDisposableEmailDomains: mapValueOfType<bool>(json, r'block_disposable_email_domains')!,
        ignoreDotsForGmailAddresses: mapValueOfType<bool>(json, r'ignore_dots_for_gmail_addresses')!,
      );
    }
    return null;
  }

  static List<InstanceRestrictions> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<InstanceRestrictions>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<InstanceRestrictions>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = InstanceRestrictions.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class InstanceRestrictionsObjectEnum {
  ...
  static const instanceRestrictions = InstanceRestrictionsObjectEnum._(r'instance_restrictions');
  ...
  static InstanceRestrictionsObjectEnum? fromJson(dynamic value) => InstanceRestrictionsObjectEnumTypeTransformer().decode(value);

  static List<InstanceRestrictionsObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class InstanceRestrictionsObjectEnumTypeTransformer {
  factory InstanceRestrictionsObjectEnumTypeTransformer() => _instance ??= const InstanceRestrictionsObjectEnumTypeTransformer._();
  ...
  InstanceRestrictionsObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'instance_restrictions': return InstanceRestrictionsObjectEnum.instanceRestrictions;
        default:
          if (!allowNull) {
