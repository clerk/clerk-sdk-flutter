...
class SchemasPasskey {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SchemasPasskey &&
    other.id == id &&
    other.object == object &&
    other.name == name &&
  ...
  @override
  String toString() => 'SchemasPasskey[id=$id, object=$object, name=$name, lastUsedAt=$lastUsedAt, verification=$verification]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SchemasPasskey[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SchemasPasskey[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return SchemasPasskey(
        ...
        verification: SchemasPasskeyVerification.fromJson(json[r'verification']),
      );
    }
    return null;
  }

  static List<SchemasPasskey> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<SchemasPasskey>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SchemasPasskey>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SchemasPasskey.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class SchemasPasskeyObjectEnum {
  ...
  static SchemasPasskeyObjectEnum? fromJson(dynamic value) => SchemasPasskeyObjectEnumTypeTransformer().decode(value);

  static List<SchemasPasskeyObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class SchemasPasskeyObjectEnumTypeTransformer {
  factory SchemasPasskeyObjectEnumTypeTransformer() => _instance ??= const SchemasPasskeyObjectEnumTypeTransformer._();
  ...
  SchemasPasskeyObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'passkey': return SchemasPasskeyObjectEnum.passkey;
        default:
          if (!allowNull) {
