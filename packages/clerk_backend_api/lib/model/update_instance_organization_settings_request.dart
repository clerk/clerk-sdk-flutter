...
class UpdateInstanceOrganizationSettingsRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UpdateInstanceOrganizationSettingsRequest &&
  ...
  @override
  String toString() => 'UpdateInstanceOrganizationSettingsRequest[enabled=$enabled, maxAllowedMemberships=$maxAllowedMemberships, adminDeleteEnabled=$adminDeleteEnabled, domainsEnabled=$domainsEnabled, domainsEnrollmentModes=$domainsEnrollmentModes, creatorRoleId=$creatorRoleId, domainsDefaultRoleId=$domainsDefaultRoleId]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UpdateInstanceOrganizationSettingsRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UpdateInstanceOrganizationSettingsRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return UpdateInstanceOrganizationSettingsRequest(
        ...
        domainsEnrollmentModes: json[r'domains_enrollment_modes'] is Iterable
            ? (json[r'domains_enrollment_modes'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        creatorRoleId: mapValueOfType<String>(json, r'creator_role_id'),
        domainsDefaultRoleId: mapValueOfType<String>(json, r'domains_default_role_id'),
      );
    }
    return null;
  }

  static List<UpdateInstanceOrganizationSettingsRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, UpdateInstanceOrganizationSettingsRequest> mapFromJson(dynamic json) {
    final map = <String, UpdateInstanceOrganizationSettingsRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UpdateInstanceOrganizationSettingsRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<UpdateInstanceOrganizationSettingsRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UpdateInstanceOrganizationSettingsRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UpdateInstanceOrganizationSettingsRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
