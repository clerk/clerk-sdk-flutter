...
class UpdateSignUpRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UpdateSignUpRequest &&
  ...
  @override
  String toString() => 'UpdateSignUpRequest[externalId=$externalId, customAction=$customAction]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UpdateSignUpRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UpdateSignUpRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UpdateSignUpRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<UpdateSignUpRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UpdateSignUpRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UpdateSignUpRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
