...
class CreateSignInTokenRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreateSignInTokenRequest &&
    other.userId == userId &&
  ...
  @override
  String toString() => 'CreateSignInTokenRequest[userId=$userId, expiresInSeconds=$expiresInSeconds]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CreateSignInTokenRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CreateSignInTokenRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return CreateSignInTokenRequest(
        ...
        expiresInSeconds: mapValueOfType<int>(json, r'expires_in_seconds') ?? 2592000,
      );
    }
    return null;
  }

  static List<CreateSignInTokenRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<CreateSignInTokenRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CreateSignInTokenRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CreateSignInTokenRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
