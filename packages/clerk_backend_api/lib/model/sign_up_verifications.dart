...
class SignUpVerifications {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SignUpVerifications &&
  ...
  @override
  String toString() => 'SignUpVerifications[emailAddress=$emailAddress, phoneNumber=$phoneNumber, web3Wallet=$web3Wallet, externalAccount=$externalAccount]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SignUpVerifications[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SignUpVerifications[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SignUpVerifications> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<SignUpVerifications>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SignUpVerifications>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SignUpVerifications.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
