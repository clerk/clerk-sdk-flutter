...
class GetOAuthAccessToken200ResponseInner {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GetOAuthAccessToken200ResponseInner &&
    other.object == object &&
  ...
  @override
  String toString() => 'GetOAuthAccessToken200ResponseInner[object=$object, externalAccountId=$externalAccountId, providerUserId=$providerUserId, token=$token, provider=$provider, publicMetadata=$publicMetadata, label=$label, scopes=$scopes, tokenSecret=$tokenSecret, expiresAt=$expiresAt]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GetOAuthAccessToken200ResponseInner[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GetOAuthAccessToken200ResponseInner[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<GetOAuthAccessToken200ResponseInner> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, GetOAuthAccessToken200ResponseInner> mapFromJson(dynamic json) {
  ...
  static Map<String, List<GetOAuthAccessToken200ResponseInner>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GetOAuthAccessToken200ResponseInner>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GetOAuthAccessToken200ResponseInner.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
