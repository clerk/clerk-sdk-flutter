...
class AllowlistIdentifier {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AllowlistIdentifier &&
    other.object == object &&
    other.id == id &&
  ...
  @override
  String toString() => 'AllowlistIdentifier[object=$object, id=$id, invitationId=$invitationId, identifier=$identifier, identifierType=$identifierType, instanceId=$instanceId, createdAt=$createdAt, updatedAt=$updatedAt]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AllowlistIdentifier[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AllowlistIdentifier[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return AllowlistIdentifier(
        ...
        identifierType: AllowlistIdentifierIdentifierTypeEnum.fromJson(json[r'identifier_type']),
  ...
  static List<AllowlistIdentifier> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<AllowlistIdentifier>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AllowlistIdentifier>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AllowlistIdentifier.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class AllowlistIdentifierObjectEnum {
  ...
  static const allowlistIdentifier = AllowlistIdentifierObjectEnum._(r'allowlist_identifier');
  ...
  static AllowlistIdentifierObjectEnum? fromJson(dynamic value) => AllowlistIdentifierObjectEnumTypeTransformer().decode(value);

  static List<AllowlistIdentifierObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class AllowlistIdentifierObjectEnumTypeTransformer {
  factory AllowlistIdentifierObjectEnumTypeTransformer() => _instance ??= const AllowlistIdentifierObjectEnumTypeTransformer._();
  ...
  AllowlistIdentifierObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'allowlist_identifier': return AllowlistIdentifierObjectEnum.allowlistIdentifier;
        default:
          if (!allowNull) {
...
class AllowlistIdentifierIdentifierTypeEnum {
  ...
  static const emailAddress = AllowlistIdentifierIdentifierTypeEnum._(r'email_address');
  static const phoneNumber = AllowlistIdentifierIdentifierTypeEnum._(r'phone_number');
  static const web3Wallet = AllowlistIdentifierIdentifierTypeEnum._(r'web3_wallet');
  ...
  static AllowlistIdentifierIdentifierTypeEnum? fromJson(dynamic value) => AllowlistIdentifierIdentifierTypeEnumTypeTransformer().decode(value);

  static List<AllowlistIdentifierIdentifierTypeEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class AllowlistIdentifierIdentifierTypeEnumTypeTransformer {
  factory AllowlistIdentifierIdentifierTypeEnumTypeTransformer() => _instance ??= const AllowlistIdentifierIdentifierTypeEnumTypeTransformer._();
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  AllowlistIdentifierIdentifierTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'email_address': return AllowlistIdentifierIdentifierTypeEnum.emailAddress;
        case r'phone_number': return AllowlistIdentifierIdentifierTypeEnum.phoneNumber;
        case r'web3_wallet': return AllowlistIdentifierIdentifierTypeEnum.web3Wallet;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
