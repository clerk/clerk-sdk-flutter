...
class UsersApi {
  ...
  Future<http.Response> banUserWithHttpInfo(String userId,) async {
    // ignore: prefer_const_declarations
    final path = r'/users/{user_id}/ban'
  ...
  Future<http.Response> createUserWithHttpInfo(CreateUserRequest createUserRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/users';
  ...
  Future<http.Response> deleteBackupCodeWithHttpInfo(String userId,) async {
    // ignore: prefer_const_declarations
    final path = r'/users/{user_id}/backup_code'
      .replaceAll('{user_id}', userId);
  ...
  Future<DisableMFA200Response?> deleteBackupCode(String userId,) async {
    final response = await deleteBackupCodeWithHttpInfo(userId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'DisableMFA200Response',) as DisableMFA200Response;
  ...
  Future<http.Response> deleteExternalAccountWithHttpInfo(String userId, String externalAccountId,) async {
    // ignore: prefer_const_declarations
  ...
  Future<DeletedObject?> deleteExternalAccount(String userId, String externalAccountId,) async {
    final response = await deleteExternalAccountWithHttpInfo(userId, externalAccountId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'DeletedObject',) as DeletedObject;
  ...
  Future<http.Response> deleteTOTPWithHttpInfo(String userId,) async {
    // ignore: prefer_const_declarations
    final path = r'/users/{user_id}/totp'
      .replaceAll('{user_id}', userId);
  ...
  Future<DisableMFA200Response?> deleteTOTP(String userId,) async {
    final response = await deleteTOTPWithHttpInfo(userId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<http.Response> deleteUserWithHttpInfo(String userId,) async {
    // ignore: prefer_const_declarations
  ...
  Future<http.Response> deleteUserProfileImageWithHttpInfo(String userId,) async {
    // ignore: prefer_const_declarations
    final path = r'/users/{user_id}/profile_image'
      .replaceAll('{user_id}', userId);
  ...
  Future<User?> deleteUserProfileImage(String userId,) async {
    final response = await deleteUserProfileImageWithHttpInfo(userId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<http.Response> disableMFAWithHttpInfo(String userId,) async {
    // ignore: prefer_const_declarations
  ...
  Future<DisableMFA200Response?> disableMFA(String userId,) async {
    final response = await disableMFAWithHttpInfo(userId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<http.Response> getOAuthAccessTokenWithHttpInfo(String userId, String provider, { bool? paginated, int? limit, int? offset, }) async {
    // ignore: prefer_const_declarations
  ...
  Future<List<GetOAuthAccessToken200ResponseInner>?> getOAuthAccessToken(String userId, String provider, { bool? paginated, int? limit, int? offset, }) async {
    final response = await getOAuthAccessTokenWithHttpInfo(userId, provider,  paginated: paginated, limit: limit, offset: offset, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      ...
      return (await apiClient.deserializeAsync(responseBody, 'List<GetOAuthAccessToken200ResponseInner>') as List)
  ...
  Future<http.Response> getUserWithHttpInfo(String userId,) async {
    // ignore: prefer_const_declarations
    final path = r'/users/{user_id}'
      .replaceAll('{user_id}', userId);
  ...
  Future<http.Response> getUserListWithHttpInfo({ List<String>? emailAddress, List<String>? phoneNumber, List<String>? externalId, List<String>? username, List<String>? web3Wallet, List<String>? userId, List<String>? organizationId, String? query, String? emailAddressQuery, String? phoneNumberQuery, String? usernameQuery, String? nameQuery, bool? banned, int? lastActiveAtBefore, int? lastActiveAtAfter, int? lastActiveAtSince, int? createdAtBefore, int? createdAtAfter, int? limit, int? offset, String? orderBy, }) async {
    // ignore: prefer_const_declarations
    final path = r'/users';
    ...
    if (organizationId != null) {
      queryParams.addAll(_queryParams('multi', 'organization_id', organizationId));
    }
    if (query != null) {
      queryParams.addAll(_queryParams('', 'query', query));
    }
    if (emailAddressQuery != null) {
      queryParams.addAll(_queryParams('', 'email_address_query', emailAddressQuery));
    }
    if (phoneNumberQuery != null) {
      queryParams.addAll(_queryParams('', 'phone_number_query', phoneNumberQuery));
    }
    ...
    if (lastActiveAtBefore != null) {
      queryParams.addAll(_queryParams('', 'last_active_at_before', lastActiveAtBefore));
    }
    if (lastActiveAtAfter != null) {
      queryParams.addAll(_queryParams('', 'last_active_at_after', lastActiveAtAfter));
    }
    if (lastActiveAtSince != null) {
      queryParams.addAll(_queryParams('', 'last_active_at_since', lastActiveAtSince));
    }
    if (createdAtBefore != null) {
      queryParams.addAll(_queryParams('', 'created_at_before', createdAtBefore));
    }
  ...
  /// * [int] createdAtAfter:
  ///   Returns users who have been created after the given date (with millisecond precision). Example: use 1730160000000 to retrieve users who have been created after 2024-10-29.
  Future<http.Response> getUsersCountWithHttpInfo({ List<String>? emailAddress, List<String>? phoneNumber, List<String>? externalId, List<String>? username, List<String>? web3Wallet, List<String>? userId, List<String>? organizationId, String? query, String? emailAddressQuery, String? phoneNumberQuery, String? usernameQuery, String? nameQuery, bool? banned, int? lastActiveAtBefore, int? lastActiveAtAfter, int? lastActiveAtSince, int? createdAtBefore, int? createdAtAfter, }) async {
    // ignore: prefer_const_declarations
  ...
  Future<TotalCount?> getUsersCount({ List<String>? emailAddress, List<String>? phoneNumber, List<String>? externalId, List<String>? username, List<String>? web3Wallet, List<String>? userId, List<String>? organizationId, String? query, String? emailAddressQuery, String? phoneNumberQuery, String? usernameQuery, String? nameQuery, bool? banned, int? lastActiveAtBefore, int? lastActiveAtAfter, int? lastActiveAtSince, int? createdAtBefore, int? createdAtAfter, }) async {
    final response = await getUsersCountWithHttpInfo( emailAddress: emailAddress, phoneNumber: phoneNumber, externalId: externalId, username: username, web3Wallet: web3Wallet, userId: userId, organizationId: organizationId, query: query, emailAddressQuery: emailAddressQuery, phoneNumberQuery: phoneNumberQuery, usernameQuery: usernameQuery, nameQuery: nameQuery, banned: banned, lastActiveAtBefore: lastActiveAtBefore, lastActiveAtAfter: lastActiveAtAfter, lastActiveAtSince: lastActiveAtSince, createdAtBefore: createdAtBefore, createdAtAfter: createdAtAfter, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'TotalCount',) as TotalCount;
  ...
  Future<http.Response> lockUserWithHttpInfo(String userId,) async {
    // ignore: prefer_const_declarations
    final path = r'/users/{user_id}/lock'
      .replaceAll('{user_id}', userId);
  ...
  Future<User?> lockUser(String userId,) async {
    final response = await lockUserWithHttpInfo(userId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// * [MultipartFile] file:
  Future<http.Response> setUserProfileImageWithHttpInfo(String userId, { http.MultipartFile? file, }) async {
    // ignore: prefer_const_declarations
    final path = r'/users/{user_id}/profile_image'
      .replaceAll('{user_id}', userId);
  ...
  ///
  /// * [MultipartFile] file:
  Future<User?> setUserProfileImage(String userId, { http.MultipartFile? file, }) async {
    final response = await setUserProfileImageWithHttpInfo(userId,  file: file, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<http.Response> unbanUserWithHttpInfo(String userId,) async {
    // ignore: prefer_const_declarations
    final path = r'/users/{user_id}/unban'
      .replaceAll('{user_id}', userId);
  ...
  Future<http.Response> unlockUserWithHttpInfo(String userId,) async {
    // ignore: prefer_const_declarations
    final path = r'/users/{user_id}/unlock'
      .replaceAll('{user_id}', userId);
  ...
  Future<User?> unlockUser(String userId,) async {
    final response = await unlockUserWithHttpInfo(userId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<http.Response> updateUserWithHttpInfo(String userId, UpdateUserRequest updateUserRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/users/{user_id}'
      .replaceAll('{user_id}', userId);
  ...
  Future<http.Response> updateUserMetadataWithHttpInfo(String userId, { UpdateUserMetadataRequest? updateUserMetadataRequest, }) async {
    // ignore: prefer_const_declarations
    final path = r'/users/{user_id}/metadata'
      .replaceAll('{user_id}', userId);
  ...
  Future<User?> updateUserMetadata(String userId, { UpdateUserMetadataRequest? updateUserMetadataRequest, }) async {
    final response = await updateUserMetadataWithHttpInfo(userId,  updateUserMetadataRequest: updateUserMetadataRequest, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<http.Response> userPasskeyDeleteWithHttpInfo(String userId, String passkeyIdentificationId,) async {
    // ignore: prefer_const_declarations
  ...
  Future<DeletedObject?> userPasskeyDelete(String userId, String passkeyIdentificationId,) async {
    final response = await userPasskeyDeleteWithHttpInfo(userId, passkeyIdentificationId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<http.Response> userWeb3WalletDeleteWithHttpInfo(String userId, String web3WalletIdentificationId,) async {
    // ignore: prefer_const_declarations
    final path = r'/users/{user_id}/web3_wallets/{web3_wallet_identification_id}'
      .replaceAll('{user_id}', userId)
      .replaceAll('{web3_wallet_identification_id}', web3WalletIdentificationId);
  ...
  Future<DeletedObject?> userWeb3WalletDelete(String userId, String web3WalletIdentificationId,) async {
    final response = await userWeb3WalletDeleteWithHttpInfo(userId, web3WalletIdentificationId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<http.Response> usersGetOrganizationInvitationsWithHttpInfo(String userId, { int? limit, int? offset, String? status, }) async {
    // ignore: prefer_const_declarations
  ...
  Future<OrganizationInvitationsWithPublicOrganizationData?> usersGetOrganizationInvitations(String userId, { int? limit, int? offset, String? status, }) async {
    final response = await usersGetOrganizationInvitationsWithHttpInfo(userId,  limit: limit, offset: offset, status: status, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'OrganizationInvitationsWithPublicOrganizationData',) as OrganizationInvitationsWithPublicOrganizationData;
  ...
  /// * [int] offset:
  ///   Skip the first `offset` results when paginating. Needs to be an integer greater or equal to zero. To be used in conjunction with `limit`.
  Future<http.Response> usersGetOrganizationMembershipsWithHttpInfo(String userId, { int? limit, int? offset, }) async {
    // ignore: prefer_const_declarations
  ...
  Future<OrganizationMemberships?> usersGetOrganizationMemberships(String userId, { int? limit, int? offset, }) async {
    final response = await usersGetOrganizationMembershipsWithHttpInfo(userId,  limit: limit, offset: offset, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'OrganizationMemberships',) as OrganizationMemberships;
  ...
  Future<http.Response> verifyPasswordWithHttpInfo(String userId, { VerifyPasswordRequest? verifyPasswordRequest, }) async {
    // ignore: prefer_const_declarations
    final path = r'/users/{user_id}/verify_password'
      .replaceAll('{user_id}', userId);
  ...
  Future<VerifyPassword200Response?> verifyPassword(String userId, { VerifyPasswordRequest? verifyPasswordRequest, }) async {
    final response = await verifyPasswordWithHttpInfo(userId,  verifyPasswordRequest: verifyPasswordRequest, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'VerifyPassword200Response',) as VerifyPassword200Response;
  ...
  Future<http.Response> verifyTOTPWithHttpInfo(String userId, { VerifyTOTPRequest? verifyTOTPRequest, }) async {
    // ignore: prefer_const_declarations
    final path = r'/users/{user_id}/verify_totp'
      .replaceAll('{user_id}', userId);
  ...
  Future<VerifyTOTP200Response?> verifyTOTP(String userId, { VerifyTOTPRequest? verifyTOTPRequest, }) async {
    final response = await verifyTOTPWithHttpInfo(userId,  verifyTOTPRequest: verifyTOTPRequest, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'VerifyTOTP200Response',) as VerifyTOTP200Response;
