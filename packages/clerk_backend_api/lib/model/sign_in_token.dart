...
class SignInToken {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SignInToken &&
    other.object == object &&
    other.id == id &&
    other.status == status &&
    other.userId == userId &&
  ...
  @override
  String toString() => 'SignInToken[object=$object, id=$id, status=$status, userId=$userId, token=$token, url=$url, createdAt=$createdAt, updatedAt=$updatedAt]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SignInToken[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SignInToken[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SignInToken> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<SignInToken>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SignInToken>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SignInToken.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class SignInTokenObjectEnum {
  ...
  static SignInTokenObjectEnum? fromJson(dynamic value) => SignInTokenObjectEnumTypeTransformer().decode(value);

  static List<SignInTokenObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class SignInTokenObjectEnumTypeTransformer {
  factory SignInTokenObjectEnumTypeTransformer() => _instance ??= const SignInTokenObjectEnumTypeTransformer._();
  ...
  SignInTokenObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'sign_in_token': return SignInTokenObjectEnum.signInToken;
        default:
          if (!allowNull) {
...
class SignInTokenStatusEnum {
  ...
  static SignInTokenStatusEnum? fromJson(dynamic value) => SignInTokenStatusEnumTypeTransformer().decode(value);

  static List<SignInTokenStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class SignInTokenStatusEnumTypeTransformer {
  factory SignInTokenStatusEnumTypeTransformer() => _instance ??= const SignInTokenStatusEnumTypeTransformer._();
  ...
  SignInTokenStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'pending': return SignInTokenStatusEnum.pending;
        case r'accepted': return SignInTokenStatusEnum.accepted;
        case r'revoked': return SignInTokenStatusEnum.revoked;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
