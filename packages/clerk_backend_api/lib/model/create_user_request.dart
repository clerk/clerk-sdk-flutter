...
class CreateUserRequest {
  ...
  int get hashCode =>
    ...
    (skipPasswordRequirement == null ? 0 : skipPasswordRequirement!.hashCode) +
    ...
    if (value is Map) {
      ...
      return CreateUserRequest(
        ...
        emailAddress: json[r'email_address'] is Iterable
            ? (json[r'email_address'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        phoneNumber: json[r'phone_number'] is Iterable
            ? (json[r'phone_number'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        web3Wallet: json[r'web3_wallet'] is Iterable
            ? (json[r'web3_wallet'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        ...
        skipPasswordRequirement: mapValueOfType<bool>(json, r'skip_password_requirement'),
