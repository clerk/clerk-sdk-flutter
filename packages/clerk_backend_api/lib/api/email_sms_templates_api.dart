...
class EmailSMSTemplatesApi {
  EmailSMSTemplatesApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<http.Response> getTemplateWithHttpInfo(String templateType, String slug,) async {
  ...
  Future<Template?> getTemplate(String templateType, String slug,) async {
    final response = await getTemplateWithHttpInfo(templateType, slug,);
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'Template',) as Template;
  ...
  Future<http.Response> getTemplateListWithHttpInfo(String templateType, { bool? paginated, int? limit, int? offset, }) async {
    // ignore: prefer_const_declarations
  ...
  Future<List<Template>?> getTemplateList(String templateType, { bool? paginated, int? limit, int? offset, }) async {
    final response = await getTemplateListWithHttpInfo(templateType,  paginated: paginated, limit: limit, offset: offset, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      ...
      return (await apiClient.deserializeAsync(responseBody, 'List<Template>') as List)
        .cast<Template>()
  ...
  ///   Required parameters
  Future<http.Response> previewTemplateWithHttpInfo(String templateType, String slug, { PreviewTemplateRequest? previewTemplateRequest, }) async {
    // ignore: prefer_const_declarations
  ...
  Future<Object?> previewTemplate(String templateType, String slug, { PreviewTemplateRequest? previewTemplateRequest, }) async {
    final response = await previewTemplateWithHttpInfo(templateType, slug,  previewTemplateRequest: previewTemplateRequest, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<http.Response> revertTemplateWithHttpInfo(String templateType, String slug,) async {
    // ignore: prefer_const_declarations
  ...
  Future<Template?> revertTemplate(String templateType, String slug,) async {
    final response = await revertTemplateWithHttpInfo(templateType, slug,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<http.Response> toggleTemplateDeliveryWithHttpInfo(String templateType, String slug, { ToggleTemplateDeliveryRequest? toggleTemplateDeliveryRequest, }) async {
    // ignore: prefer_const_declarations
  ...
  Future<Template?> toggleTemplateDelivery(String templateType, String slug, { ToggleTemplateDeliveryRequest? toggleTemplateDeliveryRequest, }) async {
    final response = await toggleTemplateDeliveryWithHttpInfo(templateType, slug,  toggleTemplateDeliveryRequest: toggleTemplateDeliveryRequest, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<http.Response> upsertTemplateWithHttpInfo(String templateType, String slug, { UpsertTemplateRequest? upsertTemplateRequest, }) async {
    // ignore: prefer_const_declarations
    final path = r'/templates/{template_type}/{slug}'
      .replaceAll('{template_type}', templateType)
      .replaceAll('{slug}', slug);
  ...
  Future<Template?> upsertTemplate(String templateType, String slug, { UpsertTemplateRequest? upsertTemplateRequest, }) async {
    final response = await upsertTemplateWithHttpInfo(templateType, slug,  upsertTemplateRequest: upsertTemplateRequest, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
