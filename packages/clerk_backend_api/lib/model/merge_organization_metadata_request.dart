...
class MergeOrganizationMetadataRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is MergeOrganizationMetadataRequest &&
  ...
  @override
  String toString() => 'MergeOrganizationMetadataRequest[publicMetadata=$publicMetadata, privateMetadata=$privateMetadata]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MergeOrganizationMetadataRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MergeOrganizationMetadataRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<MergeOrganizationMetadataRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, MergeOrganizationMetadataRequest> mapFromJson(dynamic json) {
  ...
  static Map<String, List<MergeOrganizationMetadataRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<MergeOrganizationMetadataRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = MergeOrganizationMetadataRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
