...
class PhoneNumber {
  ...
  @override
  String toString() => 'PhoneNumber[id=$id, object=$object, phoneNumber=$phoneNumber, reservedForSecondFactor=$reservedForSecondFactor, defaultSecondFactor=$defaultSecondFactor, reserved=$reserved, verification=$verification, linkedTo=$linkedTo, backupCodes=$backupCodes, createdAt=$createdAt, updatedAt=$updatedAt]';
  ...
  static PhoneNumber? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return PhoneNumber(
        ...
        reservedForSecondFactor: mapValueOfType<bool>(json, r'reserved_for_second_factor'),
        defaultSecondFactor: mapValueOfType<bool>(json, r'default_second_factor'),
...
class PhoneNumberObjectEnum {
  ...
  static PhoneNumberObjectEnum? fromJson(dynamic value) => PhoneNumberObjectEnumTypeTransformer().decode(value);

  static List<PhoneNumberObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class PhoneNumberObjectEnumTypeTransformer {
  factory PhoneNumberObjectEnumTypeTransformer() => _instance ??= const PhoneNumberObjectEnumTypeTransformer._();
  ...
  PhoneNumberObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'phone_number': return PhoneNumberObjectEnum.phoneNumber;
        default:
          if (!allowNull) {
