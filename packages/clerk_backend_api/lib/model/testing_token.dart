...
class TestingToken {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TestingToken &&
    other.object == object &&
    other.token == token &&
  ...
  @override
  String toString() => 'TestingToken[object=$object, token=$token, expiresAt=$expiresAt]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TestingToken[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TestingToken[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<TestingToken> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<TestingToken>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TestingToken>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TestingToken.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class TestingTokenObjectEnum {
  ...
  static TestingTokenObjectEnum? fromJson(dynamic value) => TestingTokenObjectEnumTypeTransformer().decode(value);

  static List<TestingTokenObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class TestingTokenObjectEnumTypeTransformer {
  factory TestingTokenObjectEnumTypeTransformer() => _instance ??= const TestingTokenObjectEnumTypeTransformer._();
  ...
  TestingTokenObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'testing_token': return TestingTokenObjectEnum.testingToken;
        default:
          if (!allowNull) {
