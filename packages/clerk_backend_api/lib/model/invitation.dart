...
class Invitation {
  ...
  @override
  String toString() => 'Invitation[object=$object, id=$id, emailAddress=$emailAddress, publicMetadata=$publicMetadata, revoked=$revoked, status=$status, url=$url, expiresAt=$expiresAt, createdAt=$createdAt, updatedAt=$updatedAt]';
...
class InvitationObjectEnum {
  ...
  static InvitationObjectEnum? fromJson(dynamic value) => InvitationObjectEnumTypeTransformer().decode(value);

  static List<InvitationObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class InvitationObjectEnumTypeTransformer {
  factory InvitationObjectEnumTypeTransformer() => _instance ??= const InvitationObjectEnumTypeTransformer._();
  ...
  InvitationObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'invitation': return InvitationObjectEnum.invitation;
        default:
          if (!allowNull) {
