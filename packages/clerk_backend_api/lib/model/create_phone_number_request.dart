...
class CreatePhoneNumberRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreatePhoneNumberRequest &&
    other.userId == userId &&
  ...
  @override
  String toString() => 'CreatePhoneNumberRequest[userId=$userId, phoneNumber=$phoneNumber, verified=$verified, primary=$primary, reservedForSecondFactor=$reservedForSecondFactor]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CreatePhoneNumberRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CreatePhoneNumberRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CreatePhoneNumberRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<CreatePhoneNumberRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CreatePhoneNumberRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CreatePhoneNumberRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
