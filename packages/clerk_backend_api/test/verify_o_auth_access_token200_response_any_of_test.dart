...
// tests for VerifyOAuthAccessToken200ResponseAnyOf
void main() {
  // final instance = VerifyOAuthAccessToken200ResponseAnyOf();

  group('test VerifyOAuthAccessToken200ResponseAnyOf', () {
    // String object
