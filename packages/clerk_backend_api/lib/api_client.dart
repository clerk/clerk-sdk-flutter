...
class ApiClient {
  ApiClient({this.basePath = 'https://api.clerk.com/v1', this.authentication,});
    ...
    try {
      switch (targetType) {
        ...
        case 'OrganizationInvitationWithPublicOrganizationData':
          return OrganizationInvitationWithPublicOrganizationData.fromJson(value);
        ...
        case 'OrganizationInvitationsWithPublicOrganizationData':
          return OrganizationInvitationsWithPublicOrganizationData.fromJson(value);
