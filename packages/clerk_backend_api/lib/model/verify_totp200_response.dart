...
class VerifyTOTP200Response {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is VerifyTOTP200Response &&
  ...
  @override
  String toString() => 'VerifyTOTP200Response[verified=$verified, codeType=$codeType]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "VerifyTOTP200Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "VerifyTOTP200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return VerifyTOTP200Response(
        ...
        codeType: VerifyTOTP200ResponseCodeTypeEnum.fromJson(json[r'code_type']),
      );
    }
    return null;
  }

  static List<VerifyTOTP200Response> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<VerifyTOTP200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<VerifyTOTP200Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = VerifyTOTP200Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class VerifyTOTP200ResponseCodeTypeEnum {
  ...
  static VerifyTOTP200ResponseCodeTypeEnum? fromJson(dynamic value) => VerifyTOTP200ResponseCodeTypeEnumTypeTransformer().decode(value);

  static List<VerifyTOTP200ResponseCodeTypeEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class VerifyTOTP200ResponseCodeTypeEnumTypeTransformer {
  factory VerifyTOTP200ResponseCodeTypeEnumTypeTransformer() => _instance ??= const VerifyTOTP200ResponseCodeTypeEnumTypeTransformer._();
  ...
  VerifyTOTP200ResponseCodeTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'totp': return VerifyTOTP200ResponseCodeTypeEnum.totp;
        case r'backup_code': return VerifyTOTP200ResponseCodeTypeEnum.backupCode;
        default:
          if (!allowNull) {
