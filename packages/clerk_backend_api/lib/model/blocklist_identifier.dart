...
class BlocklistIdentifier {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is BlocklistIdentifier &&
    other.object == object &&
    other.id == id &&
  ...
  @override
  String toString() => 'BlocklistIdentifier[object=$object, id=$id, identifier=$identifier, identifierType=$identifierType, instanceId=$instanceId, createdAt=$createdAt, updatedAt=$updatedAt]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "BlocklistIdentifier[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "BlocklistIdentifier[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return BlocklistIdentifier(
        ...
        identifierType: BlocklistIdentifierIdentifierTypeEnum.fromJson(json[r'identifier_type']),
  ...
  static List<BlocklistIdentifier> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<BlocklistIdentifier>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<BlocklistIdentifier>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = BlocklistIdentifier.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class BlocklistIdentifierObjectEnum {
  ...
  static const blocklistIdentifier = BlocklistIdentifierObjectEnum._(r'blocklist_identifier');
  ...
  static BlocklistIdentifierObjectEnum? fromJson(dynamic value) => BlocklistIdentifierObjectEnumTypeTransformer().decode(value);

  static List<BlocklistIdentifierObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class BlocklistIdentifierObjectEnumTypeTransformer {
  factory BlocklistIdentifierObjectEnumTypeTransformer() => _instance ??= const BlocklistIdentifierObjectEnumTypeTransformer._();
  ...
  BlocklistIdentifierObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'blocklist_identifier': return BlocklistIdentifierObjectEnum.blocklistIdentifier;
        default:
          if (!allowNull) {
...
class BlocklistIdentifierIdentifierTypeEnum {
  ...
  static const emailAddress = BlocklistIdentifierIdentifierTypeEnum._(r'email_address');
  static const phoneNumber = BlocklistIdentifierIdentifierTypeEnum._(r'phone_number');
  static const web3Wallet = BlocklistIdentifierIdentifierTypeEnum._(r'web3_wallet');
  ...
  static BlocklistIdentifierIdentifierTypeEnum? fromJson(dynamic value) => BlocklistIdentifierIdentifierTypeEnumTypeTransformer().decode(value);

  static List<BlocklistIdentifierIdentifierTypeEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class BlocklistIdentifierIdentifierTypeEnumTypeTransformer {
  factory BlocklistIdentifierIdentifierTypeEnumTypeTransformer() => _instance ??= const BlocklistIdentifierIdentifierTypeEnumTypeTransformer._();
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  BlocklistIdentifierIdentifierTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'email_address': return BlocklistIdentifierIdentifierTypeEnum.emailAddress;
        case r'phone_number': return BlocklistIdentifierIdentifierTypeEnum.phoneNumber;
        case r'web3_wallet': return BlocklistIdentifierIdentifierTypeEnum.web3Wallet;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
