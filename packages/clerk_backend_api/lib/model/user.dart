...
class User {
  ...
  bool operator ==(Object other) => identical(this, other) || other is User &&
    ...
    other.verificationAttemptsRemaining == verificationAttemptsRemaining &&
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.verificationAttemptsRemaining != null) {
      json[r'verification_attempts_remaining'] = this.verificationAttemptsRemaining;
    } else {
  ...
  static User? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return User(
        ...
        primaryEmailAddressId: mapValueOfType<String>(json, r'primary_email_address_id'),
        primaryPhoneNumberId: mapValueOfType<String>(json, r'primary_phone_number_id'),
        primaryWeb3WalletId: mapValueOfType<String>(json, r'primary_web3_wallet_id'),
        ...
        lockoutExpiresInSeconds: mapValueOfType<int>(json, r'lockout_expires_in_seconds'),
        verificationAttemptsRemaining: mapValueOfType<int>(json, r'verification_attempts_remaining'),
        updatedAt: mapValueOfType<int>(json, r'updated_at'),
        createdAt: mapValueOfType<int>(json, r'created_at'),
        deleteSelfEnabled: mapValueOfType<bool>(json, r'delete_self_enabled'),
        createOrganizationEnabled: mapValueOfType<bool>(json, r'create_organization_enabled'),
        createOrganizationsLimit: mapValueOfType<int>(json, r'create_organizations_limit'),
...
class UserObjectEnumTypeTransformer {
  ...
  UserObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'user': return UserObjectEnum.user;
        default:
          if (!allowNull) {
