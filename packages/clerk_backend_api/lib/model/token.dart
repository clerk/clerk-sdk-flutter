...
class Token {
  ...
  bool operator ==(Object other) =>
      ...
      other is Token && other.object == object && other.jwt == jwt;

  @override
  int get hashCode =>
      // ignore: unnecessary_parenthesis
      (object.hashCode) + (jwt.hashCode);

  @override
  String toString() => 'Token[object=$object, jwt=$jwt]';
...
class TokenObjectEnum {
  ...
  static List<TokenObjectEnum> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
...
class TokenObjectEnumTypeTransformer {
  factory TokenObjectEnumTypeTransformer() =>
      _instance ??= const TokenObjectEnumTypeTransformer._();
