...
class OrganizationInvitation {
  ...
  @override
  String toString() => 'OrganizationInvitation[object=$object, id=$id, emailAddress=$emailAddress, role=$role, roleName=$roleName, organizationId=$organizationId, status=$status, publicMetadata=$publicMetadata, privateMetadata=$privateMetadata, url=$url, expiresAt=$expiresAt, createdAt=$createdAt, updatedAt=$updatedAt]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "OrganizationInvitation[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "OrganizationInvitation[$key]" has a null value in JSON.');
        });
        return true;
      }());
...
class OrganizationInvitationObjectEnum {
  ...
  static const organizationInvitation = OrganizationInvitationObjectEnum._(r'organization_invitation');
  ...
  static OrganizationInvitationObjectEnum? fromJson(dynamic value) => OrganizationInvitationObjectEnumTypeTransformer().decode(value);

  static List<OrganizationInvitationObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class OrganizationInvitationObjectEnumTypeTransformer {
  factory OrganizationInvitationObjectEnumTypeTransformer() => _instance ??= const OrganizationInvitationObjectEnumTypeTransformer._();
  ...
  OrganizationInvitationObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'organization_invitation': return OrganizationInvitationObjectEnum.organizationInvitation;
        default:
          if (!allowNull) {
