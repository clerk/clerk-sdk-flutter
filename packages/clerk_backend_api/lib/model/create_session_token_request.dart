...
class CreateSessionTokenRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreateSessionTokenRequest &&
  ...
  @override
  String toString() => 'CreateSessionTokenRequest[expiresInSeconds=$expiresInSeconds]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CreateSessionTokenRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CreateSessionTokenRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CreateSessionTokenRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<CreateSessionTokenRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CreateSessionTokenRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CreateSessionTokenRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
