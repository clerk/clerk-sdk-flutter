...
class JWTTemplate {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is JWTTemplate &&
    other.object == object &&
    other.id == id &&
    other.name == name &&
    other.claims == claims &&
  ...
  @override
  String toString() => 'JWTTemplate[object=$object, id=$id, name=$name, claims=$claims, lifetime=$lifetime, allowedClockSkew=$allowedClockSkew, customSigningKey=$customSigningKey, signingAlgorithm=$signingAlgorithm, createdAt=$createdAt, updatedAt=$updatedAt]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "JWTTemplate[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "JWTTemplate[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<JWTTemplate> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<JWTTemplate>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<JWTTemplate>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = JWTTemplate.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class JWTTemplateObjectEnum {
  ...
  static JWTTemplateObjectEnum? fromJson(dynamic value) => JWTTemplateObjectEnumTypeTransformer().decode(value);

  static List<JWTTemplateObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class JWTTemplateObjectEnumTypeTransformer {
  factory JWTTemplateObjectEnumTypeTransformer() => _instance ??= const JWTTemplateObjectEnumTypeTransformer._();
  ...
  JWTTemplateObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'jwt_template': return JWTTemplateObjectEnum.jwtTemplate;
        default:
          if (!allowNull) {
