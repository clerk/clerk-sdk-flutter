...
class ToggleTemplateDeliveryRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ToggleTemplateDeliveryRequest &&
  ...
  @override
  String toString() => 'ToggleTemplateDeliveryRequest[deliveredByClerk=$deliveredByClerk]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ToggleTemplateDeliveryRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ToggleTemplateDeliveryRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ToggleTemplateDeliveryRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<ToggleTemplateDeliveryRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ToggleTemplateDeliveryRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ToggleTemplateDeliveryRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
