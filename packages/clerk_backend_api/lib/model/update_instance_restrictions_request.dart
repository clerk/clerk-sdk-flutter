...
class UpdateInstanceRestrictionsRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UpdateInstanceRestrictionsRequest &&
  ...
  int get hashCode =>
    ...
    (blockDisposableEmailDomains == null ? 0 : blockDisposableEmailDomains!.hashCode) +
    (ignoreDotsForGmailAddresses == null ? 0 : ignoreDotsForGmailAddresses!.hashCode);

  @override
  String toString() => 'UpdateInstanceRestrictionsRequest[allowlist=$allowlist, blocklist=$blocklist, blockEmailSubaddresses=$blockEmailSubaddresses, blockDisposableEmailDomains=$blockDisposableEmailDomains, ignoreDotsForGmailAddresses=$ignoreDotsForGmailAddresses]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UpdateInstanceRestrictionsRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UpdateInstanceRestrictionsRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UpdateInstanceRestrictionsRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, UpdateInstanceRestrictionsRequest> mapFromJson(dynamic json) {
  ...
  static Map<String, List<UpdateInstanceRestrictionsRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UpdateInstanceRestrictionsRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UpdateInstanceRestrictionsRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
