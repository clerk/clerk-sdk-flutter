...
class VerifyDomainProxyRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is VerifyDomainProxyRequest &&
  ...
  @override
  String toString() => 'VerifyDomainProxyRequest[domainId=$domainId, proxyUrl=$proxyUrl]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "VerifyDomainProxyRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "VerifyDomainProxyRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<VerifyDomainProxyRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<VerifyDomainProxyRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<VerifyDomainProxyRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = VerifyDomainProxyRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
