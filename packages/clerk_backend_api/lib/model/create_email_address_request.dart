...
class CreateEmailAddressRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreateEmailAddressRequest &&
    other.userId == userId &&
  ...
  @override
  String toString() => 'CreateEmailAddressRequest[userId=$userId, emailAddress=$emailAddress, verified=$verified, primary=$primary]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CreateEmailAddressRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CreateEmailAddressRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CreateEmailAddressRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<CreateEmailAddressRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CreateEmailAddressRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CreateEmailAddressRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
