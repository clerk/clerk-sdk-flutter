...
class SAMLConnectionAttributeMapping {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SAMLConnectionAttributeMapping &&
    other.userId == userId &&
  ...
  @override
  String toString() => 'SAMLConnectionAttributeMapping[userId=$userId, emailAddress=$emailAddress, firstName=$firstName, lastName=$lastName]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SAMLConnectionAttributeMapping[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SAMLConnectionAttributeMapping[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SAMLConnectionAttributeMapping> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<SAMLConnectionAttributeMapping>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SAMLConnectionAttributeMapping>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SAMLConnectionAttributeMapping.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
