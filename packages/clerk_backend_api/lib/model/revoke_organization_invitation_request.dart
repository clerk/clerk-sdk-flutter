...
class RevokeOrganizationInvitationRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is RevokeOrganizationInvitationRequest &&
  ...
  @override
  String toString() => 'RevokeOrganizationInvitationRequest[requestingUserId=$requestingUserId]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RevokeOrganizationInvitationRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RevokeOrganizationInvitationRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<RevokeOrganizationInvitationRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, RevokeOrganizationInvitationRequest> mapFromJson(dynamic json) {
  ...
  static Map<String, List<RevokeOrganizationInvitationRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RevokeOrganizationInvitationRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = RevokeOrganizationInvitationRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
