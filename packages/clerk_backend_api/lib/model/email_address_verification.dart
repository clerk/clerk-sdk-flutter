...
class EmailAddressVerification {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EmailAddressVerification &&
    other.status == status &&
  ...
  @override
  String toString() => 'EmailAddressVerification[status=$status, strategy=$strategy, attempts=$attempts, expireAt=$expireAt, verifiedAtClient=$verifiedAtClient, error=$error]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EmailAddressVerification[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EmailAddressVerification[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return EmailAddressVerification(
        ...
        strategy: EmailAddressVerificationStrategyEnum.fromJson(json[r'strategy'])!,
  ...
  static List<EmailAddressVerification> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<EmailAddressVerification>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EmailAddressVerification>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EmailAddressVerification.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class EmailAddressVerificationStatusEnum {
  ...
  static EmailAddressVerificationStatusEnum? fromJson(dynamic value) => EmailAddressVerificationStatusEnumTypeTransformer().decode(value);

  static List<EmailAddressVerificationStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class EmailAddressVerificationStatusEnumTypeTransformer {
  factory EmailAddressVerificationStatusEnumTypeTransformer() => _instance ??= const EmailAddressVerificationStatusEnumTypeTransformer._();
  ...
  EmailAddressVerificationStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'unverified': return EmailAddressVerificationStatusEnum.unverified;
        case r'verified': return EmailAddressVerificationStatusEnum.verified;
        case r'expired': return EmailAddressVerificationStatusEnum.expired;
        default:
          if (!allowNull) {
...
class EmailAddressVerificationStrategyEnum {
  ...
  static EmailAddressVerificationStrategyEnum? fromJson(dynamic value) => EmailAddressVerificationStrategyEnumTypeTransformer().decode(value);

  static List<EmailAddressVerificationStrategyEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class EmailAddressVerificationStrategyEnumTypeTransformer {
  factory EmailAddressVerificationStrategyEnumTypeTransformer() => _instance ??= const EmailAddressVerificationStrategyEnumTypeTransformer._();
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  EmailAddressVerificationStrategyEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'ticket': return EmailAddressVerificationStrategyEnum.ticket;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
