...
class OrganizationMembershipsApi {
  OrganizationMembershipsApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<http.Response> createOrganizationMembershipWithHttpInfo(String organizationId, CreateOrganizationMembershipRequest createOrganizationMembershipRequest,) async {
  ...
  Future<OrganizationMembership?> createOrganizationMembership(String organizationId, CreateOrganizationMembershipRequest createOrganizationMembershipRequest,) async {
    final response = await createOrganizationMembershipWithHttpInfo(organizationId, createOrganizationMembershipRequest,);
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'OrganizationMembership',) as OrganizationMembership;
  ...
  Future<http.Response> deleteOrganizationMembershipWithHttpInfo(String organizationId, String userId,) async {
    // ignore: prefer_const_declarations
  ...
  Future<OrganizationMembership?> deleteOrganizationMembership(String organizationId, String userId,) async {
    final response = await deleteOrganizationMembershipWithHttpInfo(organizationId, userId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<http.Response> instanceGetOrganizationMembershipsWithHttpInfo({ String? orderBy, int? limit, int? offset, }) async {
    // ignore: prefer_const_declarations
  ...
  Future<OrganizationMemberships?> instanceGetOrganizationMemberships({ String? orderBy, int? limit, int? offset, }) async {
    final response = await instanceGetOrganizationMembershipsWithHttpInfo( orderBy: orderBy, limit: limit, offset: offset, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [int] offset:
  ///   Skip the first `offset` results when paginating. Needs to be an integer greater or equal to zero. To be used in conjunction with `limit`.
  Future<http.Response> listOrganizationMembershipsWithHttpInfo(String organizationId, { String? orderBy, List<String>? userId, List<String>? emailAddress, List<String>? phoneNumber, List<String>? username, List<String>? web3Wallet, List<String>? role, String? query, String? emailAddressQuery, String? phoneNumberQuery, String? usernameQuery, String? nameQuery, int? lastActiveAtBefore, int? lastActiveAtAfter, int? createdAtBefore, int? createdAtAfter, int? limit, int? offset, }) async {
    // ignore: prefer_const_declarations
    final path = r'/organizations/{organization_id}/memberships'
      .replaceAll('{organization_id}', organizationId);
  ...
  Future<OrganizationMemberships?> listOrganizationMemberships(String organizationId, { String? orderBy, List<String>? userId, List<String>? emailAddress, List<String>? phoneNumber, List<String>? username, List<String>? web3Wallet, List<String>? role, String? query, String? emailAddressQuery, String? phoneNumberQuery, String? usernameQuery, String? nameQuery, int? lastActiveAtBefore, int? lastActiveAtAfter, int? createdAtBefore, int? createdAtAfter, int? limit, int? offset, }) async {
    final response = await listOrganizationMembershipsWithHttpInfo(organizationId,  orderBy: orderBy, userId: userId, emailAddress: emailAddress, phoneNumber: phoneNumber, username: username, web3Wallet: web3Wallet, role: role, query: query, emailAddressQuery: emailAddressQuery, phoneNumberQuery: phoneNumberQuery, usernameQuery: usernameQuery, nameQuery: nameQuery, lastActiveAtBefore: lastActiveAtBefore, lastActiveAtAfter: lastActiveAtAfter, createdAtBefore: createdAtBefore, createdAtAfter: createdAtAfter, limit: limit, offset: offset, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<http.Response> updateOrganizationMembershipWithHttpInfo(String organizationId, String userId, UpdateOrganizationMembershipRequest updateOrganizationMembershipRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/organizations/{organization_id}/memberships/{user_id}'
      .replaceAll('{organization_id}', organizationId)
      .replaceAll('{user_id}', userId);
  ...
  Future<OrganizationMembership?> updateOrganizationMembership(String organizationId, String userId, UpdateOrganizationMembershipRequest updateOrganizationMembershipRequest,) async {
    final response = await updateOrganizationMembershipWithHttpInfo(organizationId, userId, updateOrganizationMembershipRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<http.Response> updateOrganizationMembershipMetadataWithHttpInfo(String organizationId, String userId, { UpdateOrganizationMembershipMetadataRequest? updateOrganizationMembershipMetadataRequest, }) async {
    // ignore: prefer_const_declarations
    final path = r'/organizations/{organization_id}/memberships/{user_id}/metadata'
      .replaceAll('{organization_id}', organizationId)
      .replaceAll('{user_id}', userId);
  ...
  Future<OrganizationMembership?> updateOrganizationMembershipMetadata(String organizationId, String userId, { UpdateOrganizationMembershipMetadataRequest? updateOrganizationMembershipMetadataRequest, }) async {
    final response = await updateOrganizationMembershipMetadataWithHttpInfo(organizationId, userId,  updateOrganizationMembershipMetadataRequest: updateOrganizationMembershipMetadataRequest, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
