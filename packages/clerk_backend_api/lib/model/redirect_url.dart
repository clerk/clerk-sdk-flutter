...
class RedirectURL {
  ...
  @override
  String toString() => 'RedirectURL[object=$object, id=$id, url=$url, createdAt=$createdAt, updatedAt=$updatedAt]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RedirectURL[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RedirectURL[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<RedirectURL> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<RedirectURL>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RedirectURL>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = RedirectURL.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class RedirectURLObjectEnum {
  ...
  static RedirectURLObjectEnum? fromJson(dynamic value) => RedirectURLObjectEnumTypeTransformer().decode(value);

  static List<RedirectURLObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class RedirectURLObjectEnumTypeTransformer {
  factory RedirectURLObjectEnumTypeTransformer() => _instance ??= const RedirectURLObjectEnumTypeTransformer._();
  ...
  RedirectURLObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'redirect_url': return RedirectURLObjectEnum.redirectUrl;
        default:
          if (!allowNull) {
