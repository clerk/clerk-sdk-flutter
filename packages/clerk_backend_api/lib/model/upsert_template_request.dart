...
class UpsertTemplateRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UpsertTemplateRequest &&
    other.name == name &&
  ...
  @override
  String toString() => 'UpsertTemplateRequest[name=$name, subject=$subject, markup=$markup, body=$body, deliveredByClerk=$deliveredByClerk, fromEmailName=$fromEmailName, replyToEmailName=$replyToEmailName]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UpsertTemplateRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UpsertTemplateRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UpsertTemplateRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<UpsertTemplateRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UpsertTemplateRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UpsertTemplateRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
