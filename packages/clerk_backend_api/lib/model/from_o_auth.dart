...
class FromOAuth {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FromOAuth &&
    other.status == status &&
  ...
  @override
  String toString() => 'FromOAuth[status=$status, strategy=$strategy, error=$error, expireAt=$expireAt, attempts=$attempts, verifiedAtClient=$verifiedAtClient]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FromOAuth[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FromOAuth[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<FromOAuth> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<FromOAuth>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FromOAuth>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FromOAuth.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class FromOAuthStatusEnum {
  ...
  static FromOAuthStatusEnum? fromJson(dynamic value) => FromOAuthStatusEnumTypeTransformer().decode(value);

  static List<FromOAuthStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class FromOAuthStatusEnumTypeTransformer {
  factory FromOAuthStatusEnumTypeTransformer() => _instance ??= const FromOAuthStatusEnumTypeTransformer._();
  ...
  FromOAuthStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'unverified': return FromOAuthStatusEnum.unverified;
        case r'verified': return FromOAuthStatusEnum.verified;
        default:
          if (!allowNull) {
