...
class SAMLConnection {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SAMLConnection &&
    other.id == id &&
    other.name == name &&
    other.domain == domain &&
    other.active == active &&
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SAMLConnection[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SAMLConnection[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SAMLConnection> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<SAMLConnection>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SAMLConnection>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SAMLConnection.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
