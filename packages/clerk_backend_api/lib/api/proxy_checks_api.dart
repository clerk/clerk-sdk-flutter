...
class ProxyChecksApi {
  ProxyChecksApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<http.Response> verifyDomainProxyWithHttpInfo({ VerifyDomainProxyRequest? verifyDomainProxyRequest, }) async {
  ...
  ///
  /// * [VerifyDomainProxyRequest] verifyDomainProxyRequest:
  Future<ProxyCheck?> verifyDomainProxy({ VerifyDomainProxyRequest? verifyDomainProxyRequest, }) async {
    final response = await verifyDomainProxyWithHttpInfo( verifyDomainProxyRequest: verifyDomainProxyRequest, );
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'ProxyCheck',) as ProxyCheck;
