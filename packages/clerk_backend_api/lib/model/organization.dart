...
class Organization {
  ...
  @override
  String toString() => 'Organization[object=$object, id=$id, name=$name, slug=$slug, membersCount=$membersCount, missingMemberWithElevatedPermissions=$missingMemberWithElevatedPermissions, pendingInvitationsCount=$pendingInvitationsCount, maxAllowedMemberships=$maxAllowedMemberships, adminDeleteEnabled=$adminDeleteEnabled, publicMetadata=$publicMetadata, privateMetadata=$privateMetadata, createdBy=$createdBy, createdAt=$createdAt, updatedAt=$updatedAt]';
...
class OrganizationObjectEnum {
  ...
  static OrganizationObjectEnum? fromJson(dynamic value) => OrganizationObjectEnumTypeTransformer().decode(value);

  static List<OrganizationObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
...
class OrganizationObjectEnumTypeTransformer {
  factory OrganizationObjectEnumTypeTransformer() => _instance ??= const OrganizationObjectEnumTypeTransformer._();
  ...
  OrganizationObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'organization': return OrganizationObjectEnum.organization;
        default:
          if (!allowNull) {
