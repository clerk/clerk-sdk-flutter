...
class CreateActorTokenRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreateActorTokenRequest &&
    other.userId == userId &&
    other.actor == actor &&
  ...
  @override
  String toString() => 'CreateActorTokenRequest[userId=$userId, actor=$actor, expiresInSeconds=$expiresInSeconds, sessionMaxDurationInSeconds=$sessionMaxDurationInSeconds]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CreateActorTokenRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CreateActorTokenRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return CreateActorTokenRequest(
        ...
        expiresInSeconds: mapValueOfType<int>(json, r'expires_in_seconds') ?? 3600,
        sessionMaxDurationInSeconds: mapValueOfType<int>(json, r'session_max_duration_in_seconds') ?? 1800,
      );
    }
    return null;
  }

  static List<CreateActorTokenRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<CreateActorTokenRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CreateActorTokenRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CreateActorTokenRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
